...
@model(
    columns={'_data_modified_utc': 'date', '_metadata_modified_utc': 'datetime2', 'ANSTSIGN': 'varchar(max)', 'ANSTSIGN2': 'varchar(max)', 'ANSTSIGN2_ID_TEXT': 'varchar(max)', 'ANSTSIGN_ID_TEXT': 'varchar(max)', 'ANSTSIGN_TEXT': 'varchar(max)'},
    kind=dict(
