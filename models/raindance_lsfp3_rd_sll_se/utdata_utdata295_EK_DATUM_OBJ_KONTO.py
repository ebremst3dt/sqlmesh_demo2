...
def execute(
    ...
    **kwargs: t.Any,
	...
	SELECT TOP 10 * FROM (SELECT 
		...
		CONVERT(varchar(max), KONTO_DATUM_FOM, 126) AS konto_datum_fom,
		CONVERT(varchar(max), KONTO_DATUM_TOM, 126) AS konto_datum_tom,
	...
	FROM utdata.utdata295.EK_DATUM_OBJ_KONTO) y
