...
@model(
    columns={'_data_modified_utc': 'date', '_metadata_modified_utc': 'datetime2', 'DUMMY2': 'varchar(max)', 'TAB_RESK': 'varchar(max)', 'TAB_RESK_ID_TEXT': 'varchar(max)', 'TAB_RESK_TEXT': 'varchar(max)'},
    kind=dict(
