...
@model(
    columns={'_data_modified_utc': 'date', '_metadata_modified_utc': 'datetime2', '_source': 'varchar(max)', 'ABONNEMANGSID': 'varchar(max)', 'ANM': 'varchar(max)', 'ANSTDATUM': 'varchar(max)', 'ANSTSIGN': 'varchar(max)', 'ANTAL_KORR': 'varchar(max)', 'ATTEST': 'varchar(max)', 'AVTALID': 'varchar(max)', 'BELOPP_SEK': 'varchar(max)', 'BELOPP_VAL': 'varchar(max)', 'BETALNINGSSPARR': 'varchar(max)', 'BETALT_SEK': 'varchar(max)', 'BETALT_VAL': 'varchar(max)', 'BETDAGAR': 'varchar(max)', 'BETPAMDATUM': 'varchar(max)', 'BETVAG_BANKKONTO': 'varchar(max)', 'BETVAG_BGNR': 'varchar(max)', 'BETVAG_CBNR': 'varchar(max)', 'BETVAG_FACNR': 'varchar(max)', 'BETVAG_PGNR': 'varchar(max)', 'BETVAG_UTLNR': 'varchar(max)', 'BUNTNR': 'varchar(max)', 'DOKREF': 'varchar(max)', 'DOK_ANTAL': 'varchar(max)', 'DRANTESATS': 'varchar(max)', 'DUMMY3': 'varchar(max)', 'EREF': 'varchar(max)', 'FAKTSTATUS': 'varchar(max)', 'FAKTSTATUS2': 'varchar(max)', 'FAKTURADATUM': 'varchar(max)', 'FORFALLODATUM': 'varchar(max)', 'IRANTEBER_VAL': 'varchar(max)', 'KLARDATUM': 'varchar(max)', 'KRABATTDATUM': 'varchar(max)', 'KRABATT_VAL': 'varchar(max)', 'KRAVNIVA': 'varchar(max)', 'KUNDID': 'varchar(max)', 'KUNDRTYP': 'varchar(max)', 'KURSDIV': 'varchar(max)', 'KURSMULT': 'varchar(max)', 'LEVID': 'varchar(max)', 'LEVRTYP': 'varchar(max)', 'MED': 'varchar(max)', 'MOMS_SEK': 'varchar(max)', 'MOMS_VAL': 'varchar(max)', 'MOTTATTDAT': 'varchar(max)', 'MOTTATTSIGN': 'varchar(max)', 'NR': 'varchar(max)', 'OCRNR': 'varchar(max)', 'ORDERID': 'varchar(max)', 'OVERDRDAGAR': 'varchar(max)', 'RANTEDEB': 'varchar(max)', 'RANTEDEBDATUM': 'varchar(max)', 'RANTEDEB_VAL': 'varchar(max)', 'REGDATUM': 'varchar(max)', 'REGSIGN': 'varchar(max)', 'RESKONTRA': 'varchar(max)', 'SENASTBETDATUM': 'varchar(max)', 'TAB_AVTTYP': 'varchar(max)', 'TAB_BEHÄND': 'varchar(max)', 'TAB_BETP': 'varchar(max)', 'TAB_BETV': 'varchar(max)', 'TAB_CMALL': 'varchar(max)', 'TAB_EFAKT': 'varchar(max)', 'TAB_FÖRK': 'varchar(max)', 'TAB_MOMS': 'varchar(max)', 'TAB_MOTP': 'varchar(max)', 'TAB_RDEB': 'varchar(max)', 'TAB_REF': 'varchar(max)', 'TAB_RESENH': 'varchar(max)', 'TAB_RESK': 'varchar(max)', 'TAB_SCADAT': 'varchar(max)', 'TAB_SCANNR': 'varchar(max)', 'TAB_UBF': 'varchar(max)', 'TAB_UBK': 'varchar(max)', 'TAB_VALUTA': 'varchar(max)', 'UTILITY': 'varchar(max)', 'UTSKRDATUM': 'varchar(max)', 'VREF': 'varchar(max)', 'ZVFREFERENS': 'varchar(max)'},
    kind=dict(
...
def execute(
    ...
    **kwargs: t.Any,
	...
	FROM utdata.utdata295.RK_FAKTA_FAKTURA) y
