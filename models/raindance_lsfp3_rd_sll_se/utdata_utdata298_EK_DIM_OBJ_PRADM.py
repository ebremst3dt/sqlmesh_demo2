...
@model(
    columns={'_data_modified_utc': 'date', '_metadata_modified_utc': 'datetime2', '_source': 'varchar(max)', 'PRADM_GILTIG_FOM': 'varchar(max)', 'PRADM_GILTIG_TOM': 'varchar(max)', 'PRADM_ID': 'varchar(max)', 'PRADM_ID_TEXT': 'varchar(max)', 'PRADM_PASSIV': 'varchar(max)', 'PRADM_TEXT': 'varchar(max)'},
    kind=dict(
