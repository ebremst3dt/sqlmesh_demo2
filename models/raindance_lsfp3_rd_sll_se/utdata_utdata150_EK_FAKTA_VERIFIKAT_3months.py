...
def execute(
    ...
    **kwargs: t.Any,
	...
	SELECT * FROM (SELECT 
		...
		CAST(BUDPRE_V AS VARCHAR(MAX)) AS budpre_v,
		...
		CAST(DOMÄN_ID AS VARCHAR(MAX)) AS domän_id,
