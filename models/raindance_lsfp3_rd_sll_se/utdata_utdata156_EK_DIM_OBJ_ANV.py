...
@model(
    columns={'_data_modified_utc': 'date', '_metadata_modified_utc': 'datetime2', '_source': 'varchar(max)', 'ANV_GILTIG_FOM': 'varchar(max)', 'ANV_GILTIG_TOM': 'varchar(max)', 'ANV_ID': 'varchar(max)', 'ANV_ID_TEXT': 'varchar(max)', 'ANV_PASSIV': 'varchar(max)', 'ANV_TEXT': 'varchar(max)', 'FAC_GILTIG_FOM': 'varchar(max)', 'FAC_GILTIG_TOM': 'varchar(max)', 'FAC_ID': 'varchar(max)', 'FAC_ID_TEXT': 'varchar(max)', 'FAC_PASSIV': 'varchar(max)', 'FAC_TEXT': 'varchar(max)', 'GRUPP_GILTIG_FOM': 'varchar(max)', 'GRUPP_GILTIG_TOM': 'varchar(max)', 'GRUPP_ID': 'varchar(max)', 'GRUPP_ID_TEXT': 'varchar(max)', 'GRUPP_PASSIV': 'varchar(max)', 'GRUPP_TEXT': 'varchar(max)'},
    kind=dict(
