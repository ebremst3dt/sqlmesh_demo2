...
@model(
    columns={'_data_modified_utc': 'date', '_metadata_modified_utc': 'datetime2', '_source': 'varchar(max)', 'FTG_GILTIG_FOM': 'varchar(max)', 'FTG_GILTIG_TOM': 'varchar(max)', 'FTG_ID': 'varchar(max)', 'FTG_ID_TEXT': 'varchar(max)', 'FTG_PASSIV': 'varchar(max)', 'FTG_TEXT': 'varchar(max)'},
    kind=dict(
