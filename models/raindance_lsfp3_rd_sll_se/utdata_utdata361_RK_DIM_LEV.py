...
def execute(
    ...
    **kwargs: t.Any,
	...
	SELECT * FROM (SELECT 
		...
		CAST(LEV_TAB_ARTIST AS VARCHAR(MAX)) AS lev_tab_artist,
		CAST(LEV_TAB_ATTEST AS VARCHAR(MAX)) AS lev_tab_attest,
		CAST(LEV_TAB_BDRG AS VARCHAR(MAX)) AS lev_tab_bdrg,
