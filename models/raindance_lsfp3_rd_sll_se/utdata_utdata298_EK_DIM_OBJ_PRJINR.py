...
@model(
    columns={'_data_modified_utc': 'date', '_metadata_modified_utc': 'datetime2', '_source': 'varchar(max)', 'PRJINR_GILTIG_FOM': 'varchar(max)', 'PRJINR_GILTIG_TOM': 'varchar(max)', 'PRJINR_ID': 'varchar(max)', 'PRJINR_ID_TEXT': 'varchar(max)', 'PRJINR_PASSIV': 'varchar(max)', 'PRJINR_TEXT': 'varchar(max)'},
    kind=dict(
