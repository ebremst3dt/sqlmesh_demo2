...
@model(
    columns={'_data_modified_utc': 'date', '_metadata_modified_utc': 'datetime2', 'BOKTYP': 'varchar(max)', 'BOKTYP_ID': 'varchar(max)', 'BOKTYP_ID_TEXT': 'varchar(max)', 'BOKTYP_NR': 'varchar(max)', 'BOKTYP_TEXT': 'varchar(max)'},
    kind=dict(
