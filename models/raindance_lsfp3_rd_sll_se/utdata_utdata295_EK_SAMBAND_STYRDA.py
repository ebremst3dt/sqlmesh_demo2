...
@model(
    columns={'_data_modified_utc': 'date', '_metadata_modified_utc': 'datetime2', 'DATUM_FOM': 'varchar(max)', 'DATUM_TOM': 'varchar(max)', 'NUMERISK_VANSTER': 'varchar(max)', 'STYRD_ID': 'varchar(max)', 'STYRD_NR': 'varchar(max)', 'URVAL': 'varchar(max)'},
    kind=dict(
