...
def execute(
    ...
    **kwargs: t.Any,
	...
	SELECT TOP 10 * FROM (SELECT 
		...
		CONVERT(varchar(max), PROJ_DATUM_FOM, 126) AS proj_datum_fom,
		CONVERT(varchar(max), PROJ_DATUM_TOM, 126) AS proj_datum_tom,
	...
	FROM utdata.utdata295.EK_DATUM_OBJ_PROJ) y
