...
@model(
    columns={'_data_modified_utc': 'date', '_metadata_modified_utc': 'datetime2', 'VALUTA_DATUM_FOM': 'varchar(max)', 'VALUTA_DATUM_TOM': 'varchar(max)', 'VALUTA_GILTIG_FOM': 'varchar(max)', 'VALUTA_GILTIG_TOM': 'varchar(max)', 'VALUTA_ID': 'varchar(max)', 'VALUTA_ID_TEXT': 'varchar(max)', 'VALUTA_PASSIV': 'varchar(max)', 'VALUTA_TEXT': 'varchar(max)'},
    kind=dict(
