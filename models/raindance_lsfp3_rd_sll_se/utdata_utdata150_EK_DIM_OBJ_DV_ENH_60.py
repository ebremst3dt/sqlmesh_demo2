...
@model(
    columns={'_data_modified_utc': 'date', '_metadata_modified_utc': 'datetime2', '_source': 'varchar(max)', 'DV_GILTIG_FOM': 'varchar(max)', 'DV_GILTIG_TOM': 'varchar(max)', 'DV_ID': 'varchar(max)', 'DV_ID_TEXT': 'varchar(max)', 'DV_PASSIV': 'varchar(max)', 'DV_TEXT': 'varchar(max)'},
    kind=dict(
