...
@model(
    columns={'_data_modified_utc': 'date', '_metadata_modified_utc': 'datetime2', 'DUMMY2': 'varchar(max)', 'TAB_SCANNR': 'varchar(max)', 'TAB_SCANNR_ID_TEXT': 'varchar(max)', 'TAB_SCANNR_TEXT': 'varchar(max)'},
    kind=dict(
