...
@model(
    columns={'_data_modified_utc': 'date', '_metadata_modified_utc': 'datetime2', 'DUMMY2': 'varchar(max)', 'TAB_AVTTYP': 'varchar(max)', 'TAB_AVTTYP_ID_TEXT': 'varchar(max)', 'TAB_AVTTYP_TEXT': 'varchar(max)'},
    kind=dict(
