...
def execute(
    ...
    **kwargs: t.Any,
	...
	SELECT * FROM (SELECT 
		...
		CAST(LEV_TAB_ABONID AS VARCHAR(MAX)) AS lev_tab_abonid,
		CAST(LEV_TAB_BEHÄND AS VARCHAR(MAX)) AS lev_tab_behänd,
		...
		CAST(LEV_TAB_DEBKRE AS VARCHAR(MAX)) AS lev_tab_debkre,
		...
		CAST(LEV_TAB_RESEN2 AS VARCHAR(MAX)) AS lev_tab_resen2,
