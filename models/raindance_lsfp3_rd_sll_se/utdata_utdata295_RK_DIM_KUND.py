...
@model(
    columns={'_data_modified_utc': 'date', '_metadata_modified_utc': 'datetime2', 'ADR1': 'varchar(max)', 'ADR2': 'varchar(max)', 'ATTRIBUTE_ACTORID': 'varchar(max)', 'ATTRIBUTE_EAN': 'varchar(max)', 'BETSPARR': 'varchar(max)', 'BGNR': 'varchar(max)', 'DUMMY1': 'varchar(max)', 'ELEKTRONISK_KOMMUNIKATION': 'varchar(max)', 'ENGANG': 'varchar(max)', 'FRI1': 'varchar(max)', 'FRI2': 'varchar(max)', 'FRI3': 'varchar(max)', 'FRI4': 'varchar(max)', 'GRUPP': 'varchar(max)', 'KREDITLIMIT': 'varchar(max)', 'KUNDID': 'varchar(max)', 'KUNDID2': 'varchar(max)', 'KUNDID_ID_TEXT': 'varchar(max)', 'KUNDID_TEXT': 'varchar(max)', 'KUND_EREF': 'varchar(max)', 'KUND_TAB_AVTTYP': 'varchar(max)', 'KUND_TAB_BEHÄND': 'varchar(max)', 'KUND_TAB_BETP': 'varchar(max)', 'KUND_TAB_BETV': 'varchar(max)', 'KUND_TAB_CMALL': 'varchar(max)', 'KUND_TAB_EFAKT': 'varchar(max)', 'KUND_TAB_MOMS': 'varchar(max)', 'KUND_TAB_MOTP': 'varchar(max)', 'KUND_TAB_RDEB': 'varchar(max)', 'KUND_TAB_RESENH': 'varchar(max)', 'KUND_TAB_SPRÅK': 'varchar(max)', 'KUND_VREF': 'varchar(max)', 'LAND': 'varchar(max)', 'MOMSREG': 'varchar(max)', 'MSG_INVOIC_FORMAT': 'varchar(max)', 'MSG_INVOIC_PA': 'varchar(max)', 'MSG_INVOIC_TRANSPORT': 'varchar(max)', 'MSG_INVOIC_VAG': 'varchar(max)', 'NAMN2': 'varchar(max)', 'OMSATTNING': 'varchar(max)', 'OMSATTNINGSAR': 'varchar(max)', 'OMSATTNING_FG': 'varchar(max)', 'ORGNR': 'varchar(max)', 'ORT': 'varchar(max)', 'PASSIV': 'varchar(max)', 'PGNR': 'varchar(max)', 'SALDO': 'varchar(max)', 'SOKBEGR': 'varchar(max)', 'TELNR': 'varchar(max)'},
    kind=dict(
