...
@model(
    columns={'_data_modified_utc': 'date', '_metadata_modified_utc': 'datetime2', '_source': 'varchar(max)', 'ANV_GILTIG_FOM': 'varchar(max)', 'ANV_GILTIG_TOM': 'varchar(max)', 'ANV_ID': 'varchar(max)', 'ANV_ID_TEXT': 'varchar(max)', 'ANV_PASSIV': 'varchar(max)', 'ANV_TEXT': 'varchar(max)'},
    kind=dict(
