...
@model(
    columns={'_data_modified_utc': 'date', '_metadata_modified_utc': 'datetime2', '_source': 'varchar(max)', 'TRESKL_GILTIG_FOM': 'varchar(max)', 'TRESKL_GILTIG_TOM': 'varchar(max)', 'TRESKL_ID': 'varchar(max)', 'TRESKL_ID_TEXT': 'varchar(max)', 'TRESKL_PASSIV': 'varchar(max)', 'TRESKL_TEXT': 'varchar(max)'},
    kind=dict(
