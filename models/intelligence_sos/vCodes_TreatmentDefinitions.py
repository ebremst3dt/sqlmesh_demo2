...
@model(
    ...
    columns={'_data_modified_utc': 'datetime2', '_metadata_modified_utc': 'datetime2', '_source': 'varchar(max)', 'Name': 'varchar(max)', 'TimestampRead': 'varchar(max)', 'TreatmentDefinitionID': 'varchar(max)', 'ValidThroughDate': 'varchar(max)'},
    ...
    kind=dict(
        ...
        batch_size=5000,
        unique_key=['TreatmentDefinitionID']
    ),
    cron="@daily",
    start=start,
    enabled=True
