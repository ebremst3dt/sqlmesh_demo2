...
@model(
    ...
    columns={'_data_modified_utc': 'datetime2', '_metadata_modified_utc': 'datetime2', '_source': 'varchar(max)', 'DocumentID': 'varchar(max)', 'Group': 'varchar(max)', 'GroupComment': 'varchar(max)', 'GroupID': 'varchar(max)', 'GroupRow': 'varchar(max)', 'MedicalComment': 'varchar(max)', 'PatientID': 'varchar(max)', 'TimestampRead': 'varchar(max)', 'Version': 'varchar(max)'},
    ...
    kind=dict(
        ...
        batch_size=30,
        unique_key=['DocumentID', 'GroupRow', 'PatientID', 'Version']
    ),
    cron="@daily",
    start=start,
    enabled=True
