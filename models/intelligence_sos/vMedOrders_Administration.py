...
@model(
    ...
    kind=dict(
        ...
        batch_size=30,
        unique_key=['DocumentID', 'PatientID', 'PreparationNo', 'Row']
    ),
    cron="@daily",
    start=start,
    enabled=True
