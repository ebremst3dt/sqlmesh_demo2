...
@model(
    ...
    kind=dict(
        ...
        batch_size=5000,
        unique_key=['BillingRateID', 'CompanyID']
    ),
    cron="@daily",
    start=start,
    enabled=True
