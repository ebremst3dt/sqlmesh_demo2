...
@model(
    description="",
    columns={'_data_modified_utc': 'datetime2', '_metadata_modified_utc': 'datetime2', '_source': 'varchar(max)', 'ESOFATypeID': 'varchar(max)', 'ExcludeValuesFromDays': 'varchar(max)', 'IncludeLabValuesFromHours': 'varchar(max)', 'IncludeValuesFromDays': 'varchar(max)', 'IncludeValuesFromHours': 'varchar(max)', 'TermID': 'varchar(max)', 'TimestampRead': 'varchar(max)'},
    column_descriptions={},
    kind=dict(
