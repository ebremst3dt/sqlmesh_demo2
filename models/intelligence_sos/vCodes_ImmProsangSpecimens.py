...
@model(
    ...
    columns={'_data_modified_utc': 'datetime2', '_metadata_modified_utc': 'datetime2', '_source': 'varchar(max)', 'SpecimenID': 'varchar(max)', 'SpecimenName': 'varchar(max)', 'TimestampRead': 'varchar(max)'},
