...
@model(
    ...
    columns={'_data_modified_utc': 'datetime2', '_metadata_modified_utc': 'datetime2', '_source': 'varchar(max)', 'ConnectedLockGroupID': 'varchar(max)', 'LockGroupID': 'varchar(max)', 'TimestampRead': 'varchar(max)'},
    ...
    kind=dict(
        ...
        batch_size=5000,
        unique_key=['ConnectedLockGroupID', 'LockGroupID']
    ),
    cron="@daily",
    start=start,
    enabled=True
