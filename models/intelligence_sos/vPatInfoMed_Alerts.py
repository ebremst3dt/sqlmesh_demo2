...
@model(
    ...
    kind=dict(
        ...
        batch_size=30,
        unique_key=['PatientID', 'Row', 'Version']
    ),
    cron="@daily",
    start=start,
    enabled=True
