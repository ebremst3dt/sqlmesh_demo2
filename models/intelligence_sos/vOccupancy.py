...
@model(
    ...
    kind=dict(
        ...
        batch_size=30,
        unique_key=['CareUnitID', 'ReportDate', 'ReportTime']
    ),
    cron="@daily",
    start=start,
    enabled=True
