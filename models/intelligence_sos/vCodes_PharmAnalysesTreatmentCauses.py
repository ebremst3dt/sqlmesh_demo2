...
@model(
    ...
    columns={'_data_modified_utc': 'datetime2', '_metadata_modified_utc': 'datetime2', '_source': 'varchar(max)', 'AnalysisID': 'varchar(max)', 'TimestampRead': 'varchar(max)', 'TreatmentCauseCode': 'varchar(max)'},
    ...
    kind=dict(
        ...
        batch_size=5000,
        unique_key=['AnalysisID', 'TreatmentCauseCode']
    ),
    cron="@daily",
    start=start,
    enabled=True
