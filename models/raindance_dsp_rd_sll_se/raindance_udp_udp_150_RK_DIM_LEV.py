...
def execute(
    ...
    **kwargs: t.Any,
	...
	SELECT * FROM (SELECT 
		...
		CAST(ATTRIBUTE_FREE AS VARCHAR(MAX)) AS attribute_free,
		...
		CAST(LEV_TAB_BESTNR AS VARCHAR(MAX)) AS lev_tab_bestnr,
		CAST(LEV_TAB_BETV AS VARCHAR(MAX)) AS lev_tab_betv,
		CAST(LEV_TAB_C2 AS VARCHAR(MAX)) AS lev_tab_c2,
		CAST(LEV_TAB_CMALL AS VARCHAR(MAX)) AS lev_tab_cmall,
		CAST(LEV_TAB_CW AS VARCHAR(MAX)) AS lev_tab_cw,
		CAST(LEV_TAB_FTYP AS VARCHAR(MAX)) AS lev_tab_ftyp,
		CAST(LEV_TAB_KST AS VARCHAR(MAX)) AS lev_tab_kst,
		CAST(LEV_TAB_LAND AS VARCHAR(MAX)) AS lev_tab_land,
		CAST(LEV_TAB_MOMS AS VARCHAR(MAX)) AS lev_tab_moms,
		CAST(LEV_TAB_MOMSBE AS VARCHAR(MAX)) AS lev_tab_momsbe,
		CAST(LEV_TAB_MOTP AS VARCHAR(MAX)) AS lev_tab_motp,
		CAST(LEV_TAB_SKDAT AS VARCHAR(MAX)) AS lev_tab_skdat,
		CAST(LEV_TAB_SKNR AS VARCHAR(MAX)) AS lev_tab_sknr,
