...
@model(
    columns={'_data_modified_utc': 'date', '_metadata_modified_utc': 'datetime2', '_source': 'varchar(max)', 'YG_GILTIG_FOM': 'varchar(max)', 'YG_GILTIG_TOM': 'varchar(max)', 'YG_ID': 'varchar(max)', 'YG_ID_TEXT': 'varchar(max)', 'YG_PASSIV': 'varchar(max)', 'YG_TEXT': 'varchar(max)'},
    kind=dict(
