...
def execute(
    ...
    **kwargs: t.Any,
	...
	SELECT * FROM (SELECT 
		...
		CAST(KUND_TAB_KRREF AS VARCHAR(MAX)) AS kund_tab_krref,
		...
		CAST(KUND_TAB_VALUTA AS VARCHAR(MAX)) AS kund_tab_valuta,
		CAST(KUND_TAB_VÅRREF AS VARCHAR(MAX)) AS kund_tab_vårref,
