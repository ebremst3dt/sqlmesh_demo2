...
def execute(
    ...
    **kwargs: t.Any,
	...
	SELECT * FROM (SELECT 
		...
		CAST(ATTRIBUTE_VIAEAN AS VARCHAR(MAX)) AS attribute_viaean,
		...
		CAST(LEV_TAB_ATTEST AS VARCHAR(MAX)) AS lev_tab_attest,
		CAST(LEV_TAB_BETV AS VARCHAR(MAX)) AS lev_tab_betv,
		CAST(LEV_TAB_CMALL AS VARCHAR(MAX)) AS lev_tab_cmall,
		CAST(LEV_TAB_ITELLA AS VARCHAR(MAX)) AS lev_tab_itella,
		...
		CAST(LEV_TAB_RECALL AS VARCHAR(MAX)) AS lev_tab_recall,
