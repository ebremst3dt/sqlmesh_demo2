...
@model(
    columns={'_data_modified_utc': 'date', '_metadata_modified_utc': 'datetime2', '_source': 'varchar(max)', 'AKTI_GILTIG_FOM': 'varchar(max)', 'AKTI_GILTIG_TOM': 'varchar(max)', 'AKTI_ID': 'varchar(max)', 'AKTI_ID_TEXT': 'varchar(max)', 'AKTI_PASSIV': 'varchar(max)', 'AKTI_TEXT': 'varchar(max)'},
    kind=dict(
