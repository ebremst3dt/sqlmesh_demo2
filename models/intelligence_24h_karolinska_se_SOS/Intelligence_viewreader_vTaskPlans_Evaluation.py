...
@model(
    description="Hur planen uppfyllde målen",
    columns={'_data_modified_utc': 'datetime2', '_metadata_modified_utc': 'datetime2', '_source': 'varchar(max)', 'Description': 'varchar(max)', 'DocumentID': 'varchar(max)', 'InitiatedDate': 'varchar(max)', 'InitiatedTime': 'varchar(max)', 'PatientID': 'varchar(max)', 'ProfessionID': 'varchar(max)', 'Row': 'varchar(max)', 'SavedAtCareUnitID': 'varchar(max)', 'SavedByUserID': 'varchar(max)', 'TimestampRead': 'varchar(max)', 'TimestampSavedGPE': 'varchar(max)', 'Version': 'varchar(max)'},
