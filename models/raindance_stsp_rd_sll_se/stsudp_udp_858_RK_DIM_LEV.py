...
def execute(
    ...
    **kwargs: t.Any,
	...
	SELECT * FROM (SELECT 
		...
		CAST(LEV_TAB_ANSVAR AS VARCHAR(MAX)) AS lev_tab_ansvar,
		...
		CAST(LEV_TAB_ORDNR AS VARCHAR(MAX)) AS lev_tab_ordnr,
		CAST(LEV_TAB_RESK AS VARCHAR(MAX)) AS lev_tab_resk,
		CAST(LEV_TAB_RTYP AS VARCHAR(MAX)) AS lev_tab_rtyp,
		CAST(LEV_TAB_SCADAT AS VARCHAR(MAX)) AS lev_tab_scadat,
		CAST(LEV_TAB_SCANNR AS VARCHAR(MAX)) AS lev_tab_scannr,
		CAST(LEV_TAB_SEKT AS VARCHAR(MAX)) AS lev_tab_sekt,
		CAST(LEV_TAB_SME AS VARCHAR(MAX)) AS lev_tab_sme,
