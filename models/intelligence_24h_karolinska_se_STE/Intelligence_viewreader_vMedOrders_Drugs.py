...
@model(
    ...
    columns={'_data_modified_utc': 'datetime2', '_metadata_modified_utc': 'datetime2', '_source': 'varchar(max)', 'ATC': 'varchar(max)', 'DocumentID': 'varchar(max)', 'DosageUnitID': 'varchar(max)', 'DoseForm': 'varchar(max)', 'DoseFormCode': 'varchar(max)', 'DrugCode': 'varchar(max)', 'DrugID': 'varchar(max)', 'InternalArticleStrength': 'varchar(max)', 'IsApproved': 'varchar(max)', 'PatientID': 'varchar(max)', 'PreparationText': 'varchar(max)', 'ProductType': 'varchar(max)', 'Row': 'varchar(max)', 'SpecialDrugCode': 'varchar(max)', 'SpecialityID': 'varchar(max)', 'StdSolutionAmount': 'varchar(max)', 'Strength': 'varchar(max)', 'StrengthUnit': 'varchar(max)', 'TimestampRead': 'varchar(max)', 'UnitCode': 'varchar(max)', 'Version': 'varchar(max)'},
