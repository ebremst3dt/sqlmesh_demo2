...
@model(
    ...
    columns={'_data_modified_utc': 'datetime2', '_metadata_modified_utc': 'datetime2', '_source': 'varchar(max)', 'Description': 'varchar(max)', 'MeasurementID': 'varchar(max)', 'Template': 'varchar(max)', 'TimestampRead': 'varchar(max)'},
