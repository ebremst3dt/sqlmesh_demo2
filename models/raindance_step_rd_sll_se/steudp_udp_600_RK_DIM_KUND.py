...
def execute(
    ...
    **kwargs: t.Any,
	...
	SELECT * FROM (SELECT 
		...
		CAST(KUND_TAB_IBF AS VARCHAR(MAX)) AS kund_tab_ibf,
		...
		CAST(KUND_TAB_SEK AS VARCHAR(MAX)) AS kund_tab_sek,
