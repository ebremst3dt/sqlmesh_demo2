...
def execute(
    ...
    **kwargs: t.Any,
	...
	SELECT * FROM (SELECT 
		...
		CAST(LEV_TAB_DATUM AS VARCHAR(MAX)) AS lev_tab_datum,
		CAST(LEV_TAB_LAND AS VARCHAR(MAX)) AS lev_tab_land,
		CAST(LEV_TAB_LEV AS VARCHAR(MAX)) AS lev_tab_lev,
		CAST(LEV_TAB_MILJÖ AS VARCHAR(MAX)) AS lev_tab_miljö,
		CAST(LEV_TAB_MOMS AS VARCHAR(MAX)) AS lev_tab_moms,
		CAST(LEV_TAB_MOTP AS VARCHAR(MAX)) AS lev_tab_motp,
		CAST(LEV_TAB_RAM AS VARCHAR(MAX)) AS lev_tab_ram,
		CAST(LEV_TAB_RESK AS VARCHAR(MAX)) AS lev_tab_resk,
		CAST(LEV_TAB_SEK AS VARCHAR(MAX)) AS lev_tab_sek,
		...
		CAST(LEV_TAB_UTSÄND AS VARCHAR(MAX)) AS lev_tab_utsänd,
