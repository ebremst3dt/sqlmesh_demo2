...
def execute(
    ...
    **kwargs: t.Any,
	...
	SELECT * FROM (SELECT 
		...
		CAST(LEV_TAB_BGCNR AS VARCHAR(MAX)) AS lev_tab_bgcnr,
		CAST(LEV_TAB_ENHET AS VARCHAR(MAX)) AS lev_tab_enhet,
		CAST(LEV_TAB_KAT AS VARCHAR(MAX)) AS lev_tab_kat,
		CAST(LEV_TAB_LPMALL AS VARCHAR(MAX)) AS lev_tab_lpmall,
		CAST(LEV_TAB_MOMS AS VARCHAR(MAX)) AS lev_tab_moms,
		CAST(LEV_TAB_MOMSOM AS VARCHAR(MAX)) AS lev_tab_momsom,
