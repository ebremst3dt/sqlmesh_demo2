...
@model(
    ...
    columns={'_data_modified_utc': 'datetime2', '_metadata_modified_utc': 'datetime2', '_source': 'varchar(max)', 'DocumentID': 'varchar(max)', 'Examination': 'varchar(max)', 'ExaminationID': 'varchar(max)', 'Group': 'varchar(max)', 'GroupID': 'varchar(max)', 'IsRequired': 'varchar(max)', 'Method': 'varchar(max)', 'MethodID': 'varchar(max)', 'PatientID': 'varchar(max)', 'Row': 'varchar(max)', 'Side': 'varchar(max)', 'TimestampRead': 'varchar(max)', 'Version': 'varchar(max)'},
...
def execute(
    ...
    **kwargs: t.Any,
	...
	FROM Intelligence.viewreader.vPhysiologyOrdersGeneral_Exams) y
