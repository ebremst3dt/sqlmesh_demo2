...
@model(
 ...
 'txtdsc': 'varchar(max)'},
    ...
    cron="@daily",
    post_statements=["CREATE INDEX IF NOT EXISTS sllclockdb01_dc_sll_se_Rainbow_ST_rainbow_dig_data_modified_utc ON clockwork.Rainbow_ST_rainbow_dig (_data_modified_utc)"]
)
