...
@model(
 ...
 'wtrcod': 'varchar(max)'},
    ...
    cron="@daily",
    post_statements=["CREATE INDEX IF NOT EXISTS sllclockdb01_dc_sll_se_Rainbow_ST_rainbow_eic_data_modified_utc ON clockwork.sllclockdb01_dc_sll_se_Rainbow_ST_rainbow_eic (_data_modified_utc)"]
)
