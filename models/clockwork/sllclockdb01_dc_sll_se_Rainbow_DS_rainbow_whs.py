...
@model(
 ...
 'xtccod': 'varchar(max)'},
    ...
    cron="@daily",
    post_statements=["CREATE INDEX IF NOT EXISTS sllclockdb01_dc_sll_se_Rainbow_DS_rainbow_whs_data_modified_utc ON clockwork.sllclockdb01_dc_sll_se_Rainbow_DS_rainbow_whs (_data_modified_utc)"]
)
