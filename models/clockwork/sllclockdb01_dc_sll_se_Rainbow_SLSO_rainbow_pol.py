...
def execute(
    ...
    **kwargs: t.Any,
	...
	SELECT top 1000
		...
		CAST(cnfdsp AS VARCHAR(MAX)) AS cnfdsp,
		CAST(cnfnum AS VARCHAR(MAX)) AS cnfnum,
		CAST(cnfrcv AS VARCHAR(MAX)) AS cnfrcv,
		...
		CAST(lstdat AS VARCHAR(MAX)) AS lstdat,
		...
		CAST(orqdat AS VARCHAR(MAX)) AS orqdat,
		...
		CAST(rcvdat AS VARCHAR(MAX)) AS rcvdat,
		CAST(regdat AS VARCHAR(MAX)) AS regdat,
