...
@model(
 ...
 'txtdsc': 'varchar(max)'},
    ...
    cron="@daily",
    post_statements=["CREATE INDEX IF NOT EXISTS sllclockdb01_dc_sll_se_Rainbow_TH_rainbow_icscat_data_modified_utc ON clockwork.Rainbow_TH_rainbow_icscat (_data_modified_utc)"]
)
