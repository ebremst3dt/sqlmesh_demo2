...
def execute(
    ...
    **kwargs: t.Any,
	...
	SELECT * FROM (SELECT 
		...
		CAST(LEV_TAB_ATTESS AS VARCHAR(MAX)) AS lev_tab_attess,
		...
		CAST(LEV_TAB_E AS VARCHAR(MAX)) AS lev_tab_e,
		CAST(LEV_TAB_INKNR AS VARCHAR(MAX)) AS lev_tab_inknr,
