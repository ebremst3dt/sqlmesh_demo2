...
@model(
    table_description="Även avslutade infusioner registreras som en administrering, men historiken följer inte med. Observera att lösningar och vid behovs blandningar endast lagras som en rad i denna tabell.",
