...
@model(
    table_description="Länskoder, mappningstabell mellan TakeCare och SIL. Översätter länskoder i TakeCare till länskoder i SIL, samt anger vilka SIL-län som ska laddas per TakeCare-län.",
