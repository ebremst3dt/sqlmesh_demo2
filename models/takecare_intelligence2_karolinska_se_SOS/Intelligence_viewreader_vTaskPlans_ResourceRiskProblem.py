...
@model(
    table_description="Varför en plan bör utföras.",
    columns={'_data_modified_utc': 'datetime', '_metadata_modified_utc': 'datetime', 'CompletedDate': 'varchar(max)', 'CompletedTime': 'varchar(max)', 'Description': 'varchar(max)', 'DocumentID': 'varchar(max)', 'InitiatedDate': 'varchar(max)', 'InitiatedTime': 'varchar(max)', 'PatientID': 'varchar(max)', 'ProblemTypeID': 'varchar(max)', 'ProfessionID': 'varchar(max)', 'Row': 'varchar(max)', 'SavedAtCareUnitID': 'varchar(max)', 'SavedByUserID': 'varchar(max)', 'TimestampRead': 'varchar(max)', 'TimestampSavedGPE': 'varchar(max)', 'Version': 'varchar(max)'},
