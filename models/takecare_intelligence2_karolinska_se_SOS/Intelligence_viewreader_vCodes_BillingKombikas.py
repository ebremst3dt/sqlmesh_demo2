...
@model(
    table_description="Ekonomiska kombikor och vårdenhetsnamn. Kan kopplas till kassor i Codes_BillingCounters genom kopplingstabellen Codes_BillingCounterKombikas.",
