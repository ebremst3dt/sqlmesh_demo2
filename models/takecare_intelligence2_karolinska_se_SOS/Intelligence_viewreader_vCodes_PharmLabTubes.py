...
@model(
    table_description="Rördefinitioner för farmlab-analyser.",
    columns={'_data_modified_utc': 'datetime', '_metadata_modified_utc': 'datetime', 'TimestampRead': 'varchar(max)', 'TubeID': 'varchar(max)', 'TubeName': 'varchar(max)'},
