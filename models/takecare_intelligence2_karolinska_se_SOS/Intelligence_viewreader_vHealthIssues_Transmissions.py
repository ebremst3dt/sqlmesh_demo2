...
@model(
    table_description="I denna tabell lagras smittvägar för hälsoproblem i de fall de existarar för dokumentet.",
    columns={'_data_modified_utc': 'datetime', '_metadata_modified_utc': 'datetime', 'DocumentID': 'varchar(max)', 'PatientID': 'varchar(max)', 'TimestampRead': 'varchar(max)', 'TransmissionID': 'varchar(max)', 'Version': 'varchar(max)'},
