...
@model(
    table_description="Kontroller vars värde är en term. Kombinationsruta och Listruta. I denna tabell lagras endast en rad när en användare har fyllt i ett värde i objektet.",
