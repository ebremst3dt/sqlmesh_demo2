...
@model(
    table_description="Inskrivningskoder.",
    columns={'_data_modified_utc': 'datetime', '_metadata_modified_utc': 'datetime', 'AdmissionCode': 'varchar(max)', 'CountyID': 'varchar(max)', 'Description': 'varchar(max)', 'TimestampRead': 'varchar(max)', 'ValidThroughDate': 'varchar(max)'},
