...
@model(
    table_description="Hälsoproblem. Innehåller idag endast ordinationsorsaker för infektionsverktyget. Kommer att innehålla en lista på patientens hälsoproblem",
