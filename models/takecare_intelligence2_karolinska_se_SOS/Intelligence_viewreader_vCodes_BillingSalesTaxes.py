...
@model(
    table_description="Kassa - Momsklasser",
    columns={'_data_modified_utc': 'datetime', '_metadata_modified_utc': 'datetime', 'Country': 'varchar(max)', 'SalesTax': 'varchar(max)', 'SalesTaxClass': 'varchar(max)', 'SalesTaxID': 'varchar(max)', 'TimestampRead': 'varchar(max)', 'ValidThroughDate': 'varchar(max)'},
