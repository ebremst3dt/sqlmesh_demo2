...
@model(
    table_description="Allmän och övergripande data för varje journalanteckning. En anteckning kan innehålla flera sökord och varje sökord kan ha olika datatyper.",
