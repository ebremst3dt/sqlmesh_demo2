...
@model(
    table_description="Kassa - Artiklar. Anger vilka företagsID som är giltiga för en post i huvudtabellen.",
    columns={'_data_modified_utc': 'datetime', '_metadata_modified_utc': 'datetime', 'ArticleID': 'varchar(max)', 'CompanyID': 'varchar(max)', 'Row': 'varchar(max)', 'TimestampRead': 'varchar(max)'},
