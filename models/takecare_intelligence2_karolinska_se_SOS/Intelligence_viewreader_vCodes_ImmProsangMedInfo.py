...
@model(
    table_description="Kompletterande uppgifter (tidigare medicinsk information) som kan anges eller begäras vid en beställning (Immunologi Prosang analyskatalog)",
