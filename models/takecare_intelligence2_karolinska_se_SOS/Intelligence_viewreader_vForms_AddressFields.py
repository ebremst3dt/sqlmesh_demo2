...
@model(
    table_description="Adressfält. I denna tabell lagras endast en rad när en användare har fyllt i ett värde i objektet.",
...
def execute(
    ...
    **kwargs: t.Any,
	...
	FROM Intelligence.viewreader.vForms_AddressFields) y
