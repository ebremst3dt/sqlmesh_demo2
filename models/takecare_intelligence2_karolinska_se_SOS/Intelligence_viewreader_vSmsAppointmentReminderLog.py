...
@model(
    table_description="Logg för bokningspåminnelser via SMS.",
    columns={'_data_modified_utc': 'datetime', '_metadata_modified_utc': 'datetime', 'AppointmentID': 'varchar(max)', 'BatchDate': 'varchar(max)', 'BatchID': 'varchar(max)', 'BatchTime': 'varchar(max)', 'CareUnitID': 'varchar(max)', 'EndDate': 'varchar(max)', 'LogDateTime': 'varchar(max)', 'PatientID': 'varchar(max)', 'ReservationDate': 'varchar(max)', 'ReservationTime': 'varchar(max)', 'ResourceID': 'varchar(max)', 'Row': 'varchar(max)', 'SMSDestination': 'varchar(max)', 'SMSText': 'varchar(max)', 'SlotLength': 'varchar(max)', 'StartDate': 'varchar(max)', 'StatusID': 'varchar(max)', 'TimestampRead': 'varchar(max)'},
