...
@model(
    table_description="GVR-transaktioner för slutenvården. Om de sex fälten (GVRs interna nyckelfält) PatientID, EventDate, EventTime, Hospital, Clinic och CareUnit har samma värde för flera slutenvårdstransaktioner så hör transaktionerna ihop.",
