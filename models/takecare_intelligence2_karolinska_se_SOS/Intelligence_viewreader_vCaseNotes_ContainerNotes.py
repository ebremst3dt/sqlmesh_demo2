...
@model(
    table_description="Data som lagras per cell. Raderna hör ihop som en inmatning, där varje kolumn kan ses som en egenskap på det inmatade datat. Denna cell innehåller text.",
