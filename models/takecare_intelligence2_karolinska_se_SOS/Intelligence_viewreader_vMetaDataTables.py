...
@model(
    table_description="Innehåller metadata för tabeller. Inte alla tabeller existerar i alla installationer. Tabellgruppen kan komma att fyllas på med mer metadata allteftersom.",
