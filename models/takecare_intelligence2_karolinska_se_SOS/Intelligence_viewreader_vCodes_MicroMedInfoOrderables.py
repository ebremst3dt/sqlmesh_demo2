...
@model(
    table_description="Vilka kompletterande uppgifter (tidigare medicinsk information) som hör till varje beställningsspec. (Mikrolabb analyskatalog)",
...
def execute(
    ...
    **kwargs: t.Any,
	...
	FROM Intelligence.viewreader.vCodes_MicroMedInfoOrderables) y
