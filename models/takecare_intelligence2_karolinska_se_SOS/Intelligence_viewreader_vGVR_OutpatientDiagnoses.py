...
@model(
    table_description="Registrering/korrigering av medicinska uppgifter (Diagnoser) för öppenvården. Om diagnosen har en orsakskod så lagras den som en rad i den här tabellen.",
