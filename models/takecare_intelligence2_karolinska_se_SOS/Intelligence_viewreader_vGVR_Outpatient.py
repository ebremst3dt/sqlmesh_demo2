...
@model(
    table_description="GVR-transaktioner för öppenvården. Om de sex fälten (GVRs interna nyckelfält) PatientID, EventDate, EventTime, Hospital, Clinic och CareUnit har samma värde för flera öppenvårdstransaktioner så hör transaktionerna ihop.",
