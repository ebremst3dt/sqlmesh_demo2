...
@model(
    table_description="En journaltextmall används som utgångspunkt för en journalanteckning (samma för alla versioner). Tilläggsmallar kan användas för att utöka den första mallen med fler grupperade sökord. Mallarnas id:n är unika per vårdenhet, oavsett typ. Systemgemensamma mallars id:n är dock globalt unika. Mallinformationen finns endast för journalanteckningar skrivna från och med sommaren 2006, tidigare sparades endast mallnamnet och inte mall-ID.",
    columns={'_data_modified_utc': 'datetime', '_metadata_modified_utc': 'datetime', 'CareUnitID': 'varchar(max)', 'DocumentID': 'varchar(max)', 'IsAdditionalTemplate': 'varchar(max)', 'PatientID': 'varchar(max)', 'TemplateID': 'varchar(max)', 'TemplateName': 'varchar(max)', 'TimestampRead': 'varchar(max)', 'Version': 'varchar(max)'},
