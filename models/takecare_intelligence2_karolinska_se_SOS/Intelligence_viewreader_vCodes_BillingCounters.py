...
@model(
    table_description="Kassor. Kan kopplas till ekonomiska vårdenheter/kombikor i Codes_BillingKombikas genom kopplingstabellen Codes_BillingCounterKombikas. Kassor som saknar koppling till kombikor i Codes_BillingCounterKombikas, visas i TakeCare upp som kopplade till alla kombikor i vårdenhetsregistret.",
