...
@model(
    table_description="Konsultationssvar. Är svar på beställning från remittent. Bedömarens svar skickas till svarsmottagaren. Svar kan både skickas iväg och tas emot. Remisser kan skickas mellan olika system och då kan interna id:n som vårdenhet saknas.",
