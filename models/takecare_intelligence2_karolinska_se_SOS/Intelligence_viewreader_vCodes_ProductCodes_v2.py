...
@model(
    table_description="Produkter för DRG. Kommer ursprungligen från kodservern. Innehåller alla versioner. För produkttyp A saknas giltigt t.o.m. datum, Intelligence lagrar därför det konstruerade datumet 2099-09-09 i ValidThroughDate då denna kolumn ingår i primärnyckeln. Produkttyp E kan innehålla rader där ProductType, ProductCode och ValidThroughDate är samma men där övriga kolumner skiljer sig. Kolumnen Row har därför lagts till.",
