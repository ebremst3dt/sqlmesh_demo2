...
@model(
    table_description="Orsak till ändring av bokning. Anledning till varför en vårdkontakt ställs in.",
    columns={'_data_modified_utc': 'datetime', '_metadata_modified_utc': 'datetime', 'AppPostponementReasonID': 'varchar(max)', 'LongName': 'varchar(max)', 'Name': 'varchar(max)', 'TimestampRead': 'varchar(max)', 'ValidThroughDate': 'varchar(max)'},
