...
@model(
    table_description="Materiel som används vid en beställning (Immunologi Prosang analyskatalog)",
    columns={'_data_modified_utc': 'datetime', '_metadata_modified_utc': 'datetime', 'LIDNoExt': 'varchar(max)', 'MaterielID': 'varchar(max)', 'MaterielName': 'varchar(max)', 'MaterielShortName': 'varchar(max)', 'TimestampRead': 'varchar(max)'},
