...
@model(
    table_description="Läkemedel (preparat) som ingår i ordination. Preparaten har antingen id från Apotekets varuregister/SIL, ett internt id för specialpreparat, eller inget id alls (för egna preparat). En rad per läkemedel för denna ordination. Vid blandning eller stamlösning anges flera rader. ATC-koder fås genom att slå i Apotekets varuregister/SIL.",
