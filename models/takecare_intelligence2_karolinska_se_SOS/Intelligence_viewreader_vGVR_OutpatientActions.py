...
@model(
    table_description="Registrering/korrigering av medicinska uppgifter (Åtgärder/Operationer) för öppenvården. Varje åtgärd hör ihop med en diagnos.",
...
def execute(
    ...
    **kwargs: t.Any,
	...
	FROM Intelligence.viewreader.vGVR_OutpatientActions) y
