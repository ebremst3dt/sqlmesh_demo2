...
@model(
    ...
    columns={'_data_modified_utc': 'datetime', '_metadata_modified_utc': 'datetime', 'AccessionNumber': 'varchar(max)', 'DocumentID': 'varchar(max)', 'ExamDateTime': 'varchar(max)', 'MethodCode': 'varchar(max)', 'Organ': 'varchar(max)', 'OrganID': 'varchar(max)', 'PatientID': 'varchar(max)', 'Row': 'varchar(max)', 'SequenceID': 'varchar(max)', 'Side': 'varchar(max)', 'StatusCode': 'varchar(max)', 'StatusComment': 'varchar(max)', 'StatusEventDateTime': 'varchar(max)', 'TimestampRead': 'varchar(max)', 'Version': 'varchar(max)'},
