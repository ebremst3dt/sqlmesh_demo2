...
@model(
    table_description="Termer i termkatalogen. Termer kan höra till olika kategorier, vilket avgör var i TakeCare de används. De kan också ha olika datatyper, vilket avgör hur de matas in. Termer ska aldrig byta datatyp, villkor etc, under sin livslängd.",
