...
@model(
    table_description="Ordinationsdata för specifika dagar. Tillsammans med doseringsdata får man alla administreringsuppgifter för en specifik dag. Denna data gäller varje dag, hela dagarna, från och med angivet datum.",
