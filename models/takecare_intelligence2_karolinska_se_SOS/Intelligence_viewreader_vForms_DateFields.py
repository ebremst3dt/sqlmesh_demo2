...
@model(
    table_description="Datumfält. I denna tabell lagras endast en rad när en användare har fyllt i ett värde i objektet.",
...
def execute(
    ...
    **kwargs: t.Any,
	...
	SELECT * FROM (SELECT 
		...
		CONVERT(varchar(max), Value, 126) AS Value,
		CAST(Version AS VARCHAR(MAX)) AS Version 
	FROM Intelligence.viewreader.vForms_DateFields) y
