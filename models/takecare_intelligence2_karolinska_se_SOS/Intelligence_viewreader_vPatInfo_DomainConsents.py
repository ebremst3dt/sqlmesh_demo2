...
@model(
    table_description="Samtycke domänöverskridning. Samtycken kan inte ändras i efterhand, men de kan inaktiveras för att ersättas av ett nytt samtycke. Används endast om delsystemet sammanhållen journalföring inte är aktiverat.",
