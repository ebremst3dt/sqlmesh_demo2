...
def execute(
    ...
    **kwargs: t.Any,
	...
	SELECT * FROM (SELECT 
		...
		CAST(ExecutionStatus AS VARCHAR(MAX)) AS ExecutionStatus,
		CAST(ExecutionVersion AS VARCHAR(MAX)) AS ExecutionVersion,
	...
	FROM Intelligence.viewreader.vTasks2_Executions) y
