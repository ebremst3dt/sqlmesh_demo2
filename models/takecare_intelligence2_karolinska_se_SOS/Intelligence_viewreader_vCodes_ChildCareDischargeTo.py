...
@model(
    table_description="Typ av mottagare för utskrivning från BHV.",
    columns={'_data_modified_utc': 'datetime', '_metadata_modified_utc': 'datetime', 'ChildCareDischargeToID': 'varchar(max)', 'Name': 'varchar(max)', 'TimestampRead': 'varchar(max)', 'ValidThroughDate': 'varchar(max)'},
