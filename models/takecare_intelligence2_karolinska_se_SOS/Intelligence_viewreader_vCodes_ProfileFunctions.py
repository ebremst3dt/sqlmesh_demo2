...
@model(
    table_description="Funktioner kopplade till en användarprofil.",
    columns={'_data_modified_utc': 'datetime', '_metadata_modified_utc': 'datetime', 'FunctionID': 'varchar(max)', 'ProfileID': 'varchar(max)', 'TimestampRead': 'varchar(max)'},
