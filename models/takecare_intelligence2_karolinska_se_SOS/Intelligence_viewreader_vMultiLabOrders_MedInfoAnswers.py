...
@model(
    table_description="Det användaren skriver in i kompletterande uppgifter (tidigare medicinsk information). Innehåller en rad per rad i Kompl. uppgifter för de flesta analyser med några få analyser kan ha kompl. uppgifter som genererar flera rader.",
...
def execute(
    ...
    **kwargs: t.Any,
	...
	FROM Intelligence.viewreader.vMultiLabOrders_MedInfoAnswers) y
