...
@model(
    ...
    columns={'_data_modified_utc': 'datetime', '_metadata_modified_utc': 'datetime', 'Analysis': 'varchar(max)', 'AnalysisID': 'varchar(max)', 'Batch': 'varchar(max)', 'DocumentID': 'varchar(max)', 'Examination': 'varchar(max)', 'ExaminationID': 'varchar(max)', 'IsAllRequired': 'varchar(max)', 'IsRequired': 'varchar(max)', 'Localization': 'varchar(max)', 'OrderableID': 'varchar(max)', 'PatientID': 'varchar(max)', 'Row': 'varchar(max)', 'SectionCode': 'varchar(max)', 'ServiceGroup': 'varchar(max)', 'Specimen': 'varchar(max)', 'SpecimenID': 'varchar(max)', 'TimestampRead': 'varchar(max)', 'TubeID': 'varchar(max)', 'Version': 'varchar(max)'},
    column_descriptions={'PatientID': "{'title_ui': None, 'description': 'Patientens id (person- eller reservnummer)'}", 'DocumentID': "{'title_ui': None, 'description': 'Internt id som identifierar dokumentet i journalen'}", 'Version': "{'title_ui': None, 'description': 'Löpnummer för version av dokument. Kan förändras mellan körningar.'}", 'Row': "{'title_ui': None, 'description': 'Internt rad- eller löpnummer'}", 'OrderableID': "{'title_ui': None, 'description': 'Kod för vald beställningsspec. Dvs. beställningsbar kombination av analys, undersökning, rör och provmaterial'}", 'SpecimenID': "{'title_ui': None, 'description': 'Kod för valt provmaterial'}", 'Specimen': "{'title_ui': 'Provmaterial', 'description': None}", 'ExaminationID': "{'title_ui': None, 'description': 'Kod för vald undersökning'}", 'Examination': "{'title_ui': 'Analyser', 'description': 'Vald undersökning i klartext'}", 'AnalysisID': "{'title_ui': None, 'description': 'Kod för vald analys'}", 'Analysis': "{'title_ui': 'Analyser', 'description': 'Vald analys i klartext'}", 'TubeID': "{'title_ui': None, 'description': 'Rörkod'}", 'Localization': "{'title_ui': 'Lokalisation', 'description': 'Var på kroppen som provet tagits.'}", 'ServiceGroup': "{'title_ui': None, 'description': 'Tjänstegrupp/Paket'}", 'IsAllRequired': "{'title_ui': None, 'description': 'Samtliga analyser är obligatoriska inom paketet'}", 'IsRequired': "{'title_ui': None, 'description': 'Analysen är obligatorisk inom paketet'}", 'Batch': "{'title_ui': 'Paket', 'description': None}", 'SectionCode': "{'title_ui': None, 'description': 'Sektionskod. Anger vilken sektion inom Mikrolab som skall analysera provet.'}", 'TimestampRead': "{'title_ui': None, 'description': 'När data lästs in från TakeCare-databasen'}"},
    kind=dict(
...
def execute(
    ...
    **kwargs: t.Any,
	...
	FROM Intelligence.viewreader.vMicroLabOrders_Analyses) y
