...
@model(
    table_description="Koppling mellan substanser/preparat och farmlab-analyser. (MultiLabb analyskatalog)",
    columns={'_data_modified_utc': 'datetime', '_metadata_modified_utc': 'datetime', 'OrderRegistryFileName': 'varchar(max)', 'OrderableID': 'varchar(max)', 'SubstancePreparationID': 'varchar(max)', 'TimestampRead': 'varchar(max)'},
