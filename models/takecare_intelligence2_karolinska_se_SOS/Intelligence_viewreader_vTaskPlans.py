...
@model(
    table_description="En aktivitetsplan är en mall för vilka aktiviteter som behöver göras för en patient. Aktiviteterna kan ha ett mål och resultatet kan utvärderas med fritext.",
