...
def execute(
    ...
    **kwargs: t.Any,
	...
	SELECT * FROM (SELECT 
		...
		CAST(Materiel AS VARCHAR(MAX)) AS Materiel,
	...
	FROM Intelligence.viewreader.vImmLabOrdersProsang) y
