...
@model(
    table_description="Medicinska patientuppgifter (vissa delar av modulen Patientuppgifter i TakeCare). I dagsläget påverkar inte användarens och dokumentets vårdenhet behörighet, utan alla har rätt att se allt data i denna tabell. Versionshanteras, men endast den senaste versionen visas upp.",
