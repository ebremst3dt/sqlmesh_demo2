...
@model(
    table_description="Riktiga mätvärden lagras i journaltext från våren 2006. Tidigare lagrades fritextvärden. Mätvärden finns även i tabellerna Measurements och Emergency_TriageVitalMeasurements.",
