...
@model(
    table_description="Beställningsspec. En specifikation består av en unik kombination av flera men inte alltid alla av följande: analys, undersökning, rör, provmaterial. (Mikrolabb analyskatalog)",
