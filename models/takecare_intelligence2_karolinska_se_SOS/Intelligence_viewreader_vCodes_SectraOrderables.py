...
@model(
    table_description="Beställningsbara undersökningar (Röntgen Sectra analyskatalog)",
    columns={'_data_modified_utc': 'datetime', '_metadata_modified_utc': 'datetime', 'ExaminationID': 'varchar(max)', 'IsSideRequired': 'varchar(max)', 'MethodID': 'varchar(max)', 'OrderableID': 'varchar(max)', 'TimestampRead': 'varchar(max)'},
