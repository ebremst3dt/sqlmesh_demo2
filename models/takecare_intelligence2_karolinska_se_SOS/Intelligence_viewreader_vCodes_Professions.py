...
@model(
    table_description="Yrkesgrupper",
    columns={'_data_modified_utc': 'datetime', '_metadata_modified_utc': 'datetime', 'HSATitle': 'varchar(max)', 'NamePlural': 'varchar(max)', 'NameShort': 'varchar(max)', 'NameSingular': 'varchar(max)', 'ProfessionID': 'varchar(max)', 'SLLID': 'varchar(max)', 'TimestampRead': 'varchar(max)', 'ValidThroughDate': 'varchar(max)'},
