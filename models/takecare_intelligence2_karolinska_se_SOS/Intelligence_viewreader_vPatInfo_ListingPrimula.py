...
@model(
    table_description="Listningsuppgifter från systemet Primula. Används bara på Gotland.",
    columns={'_data_modified_utc': 'datetime', '_metadata_modified_utc': 'datetime', 'Active': 'varchar(max)', 'ChangeDate': 'varchar(max)', 'CreatedDate': 'varchar(max)', 'DoctorCode': 'varchar(max)', 'DoctorFirstName': 'varchar(max)', 'DoctorSurname': 'varchar(max)', 'ListingID': 'varchar(max)', 'MedicalCenter': 'varchar(max)', 'MedicalCenterCode': 'varchar(max)', 'MedicalCenterType': 'varchar(max)', 'MedicalCenterTypeFirstLetter': 'varchar(max)', 'PatientID': 'varchar(max)', 'ReadDate': 'varchar(max)', 'TimestampRead': 'varchar(max)'},
