...
@model(
    table_description="Digital diktering. En sparad ljudfil kan ej modifieras, däremot kan vissa kolumner i dokumenttypen modifieras: PriorityID, LinkedDocumentTemplateID, SavedAtCareUnitID. Dokumenttypen versionshanteras ej.",
