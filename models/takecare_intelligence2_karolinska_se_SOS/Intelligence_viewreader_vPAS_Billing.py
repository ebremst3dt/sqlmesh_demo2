...
@model(
    table_description="Kassabesök. Vid makulering skapas en ny transaktion (makuleringstransaktion), och den ursprungliga flaggas som makulerad. Det kan också skapas transaktioner som endast är fakturaunderlag.",
