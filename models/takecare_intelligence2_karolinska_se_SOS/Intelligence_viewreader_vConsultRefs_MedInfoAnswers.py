...
@model(
    table_description="Det användaren skriver in i kompletterande uppgifter (tidigare medicinsk information). Innehåller en rad per rad i Kompl. uppgifter för de flesta orsaker med några få orsaker kan ha kompl. uppgifter som genererar flera rader.",
