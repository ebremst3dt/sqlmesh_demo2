...
@model(
    table_description="Utskrivningsklar (hette tidigare medicinskt färdigbehandlad). När patienten anses vara färdig för utskrivning. Påverkar ersättning från kommunen vid samordnad vårdplanering.",
