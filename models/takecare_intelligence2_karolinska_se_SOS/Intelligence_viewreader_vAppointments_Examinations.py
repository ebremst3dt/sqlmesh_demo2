...
@model(
    table_description="Undersökningar kopplade till ett bokningsunderlag. Använd tidpunkt sparad för att se vilken version av bokningsunderlaget som hade vilka kopplingar.",
