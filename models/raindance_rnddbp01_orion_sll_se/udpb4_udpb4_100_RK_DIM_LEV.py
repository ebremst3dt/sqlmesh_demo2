...
def execute(
    ...
    **kwargs: t.Any,
	...
	SELECT * FROM (SELECT 
		...
		CAST(LEV_TAB_ABONNR AS VARCHAR(MAX)) AS lev_tab_abonnr,
		CAST(LEV_TAB_BETV AS VARCHAR(MAX)) AS lev_tab_betv,
		CAST(LEV_TAB_BUNDAT AS VARCHAR(MAX)) AS lev_tab_bundat,
		CAST(LEV_TAB_CMALL AS VARCHAR(MAX)) AS lev_tab_cmall,
		CAST(LEV_TAB_INKORD AS VARCHAR(MAX)) AS lev_tab_inkord,
		CAST(LEV_TAB_MOMS AS VARCHAR(MAX)) AS lev_tab_moms,
		CAST(LEV_TAB_MOTP AS VARCHAR(MAX)) AS lev_tab_motp,
		CAST(LEV_TAB_PREL AS VARCHAR(MAX)) AS lev_tab_prel,
		CAST(LEV_TAB_RESK AS VARCHAR(MAX)) AS lev_tab_resk,
		CAST(LEV_TAB_SKANNR AS VARCHAR(MAX)) AS lev_tab_skannr,
		CAST(LEV_TAB_SKOD AS VARCHAR(MAX)) AS lev_tab_skod,
		CAST(LEV_TAB_UBF AS VARCHAR(MAX)) AS lev_tab_ubf,
		CAST(LEV_TAB_UBK AS VARCHAR(MAX)) AS lev_tab_ubk,
		CAST(LEV_TAB_VAL AS VARCHAR(MAX)) AS lev_tab_val,
