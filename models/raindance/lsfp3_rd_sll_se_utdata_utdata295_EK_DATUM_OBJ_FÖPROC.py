...
def execute(
    ...
    **kwargs: t.Any,
    ...
    query = """SELECT CAST(FÖPROC_DATUM_FOM AS VARCHAR(MAX)) AS FÖPROC_DATUM_FOM,
...
CAST(FÖPROC_TEXT AS VARCHAR(MAX)) AS FÖPROC_TEXT FROM utdata.utdata295.EK_DATUM_OBJ_FÖPROC"""
