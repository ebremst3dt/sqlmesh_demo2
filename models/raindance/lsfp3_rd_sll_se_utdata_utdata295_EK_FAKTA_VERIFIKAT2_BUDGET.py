...
@model(
 ...
 'BPUTF_V': 'varchar(max)',
 'BUDGET_01': 'varchar(max)',
 'BUDGET_02': 'varchar(max)',
 'BUDGET_03': 'varchar(max)',
 'BUDGET_04': 'varchar(max)',
 'BUDGET_05': 'varchar(max)',
 'BUDGET_06': 'varchar(max)',
 'BUDGET_07': 'varchar(max)',
 'BUDGET_08': 'varchar(max)',
 'BUDGET_09': 'varchar(max)',
 'BUDGET_10': 'varchar(max)',
 'BUDGET_11': 'varchar(max)',
 'BUDGET_12': 'varchar(max)',
...
CAST(YKAT_ID AS VARCHAR(MAX)) AS YKAT_ID FROM utdata.utdata295.EK_FAKTA_VERIFIKAT2_BUDGET"""
