...
@model(
    columns={'FRI2_DATUM_FOM': 'varchar(max)',
 'FRI2_DATUM_TOM': 'varchar(max)',
 'FRI2_GILTIG_FOM': 'varchar(max)',
...
def execute(
    ...
    **kwargs: t.Any,
    ...
    query = """SELECT CAST(FRI2_DATUM_FOM AS VARCHAR(MAX)) AS FRI2_DATUM_FOM,
CAST(FRI2_DATUM_TOM AS VARCHAR(MAX)) AS FRI2_DATUM_TOM,
...
CAST(FRI2_TEXT AS VARCHAR(MAX)) AS FRI2_TEXT FROM utdata.utdata295.EK_DATUM_OBJ_FRI2"""
