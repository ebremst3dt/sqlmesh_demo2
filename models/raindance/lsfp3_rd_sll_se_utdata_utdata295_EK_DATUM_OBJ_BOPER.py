...
def execute(
    ...
    **kwargs: t.Any,
    ...
    query = """SELECT CAST(BOPER_DATUM_FOM AS VARCHAR(MAX)) AS BOPER_DATUM_FOM,
...
CAST(BOPER_TEXT AS VARCHAR(MAX)) AS BOPER_TEXT FROM utdata.utdata295.EK_DATUM_OBJ_BOPER"""
