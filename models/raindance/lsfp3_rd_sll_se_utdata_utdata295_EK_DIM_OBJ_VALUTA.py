...
def execute(
    ...
    **kwargs: t.Any,
    ...
    query = """SELECT CAST(VALUTA_GILTIG_FOM AS VARCHAR(MAX)) AS VALUTA_GILTIG_FOM,
...
CAST(VALUTA_TEXT AS VARCHAR(MAX)) AS VALUTA_TEXT FROM utdata.utdata295.EK_DIM_OBJ_VALUTA"""
