...
def execute(
    ...
    **kwargs: t.Any,
    ...
    query = """SELECT CAST(AVTBES_DATUM_FOM AS VARCHAR(MAX)) AS AVTBES_DATUM_FOM,
...
CAST(AVTBES_TEXT AS VARCHAR(MAX)) AS AVTBES_TEXT FROM utdata.utdata295.EK_DATUM_OBJ_AVTBES"""
