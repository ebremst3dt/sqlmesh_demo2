...
@model(
    columns={'PNYCKL_DATUM_FOM': 'varchar(max)',
 'PNYCKL_DATUM_TOM': 'varchar(max)',
 'PNYCKL_GILTIG_FOM': 'varchar(max)',
...
def execute(
    ...
    **kwargs: t.Any,
    ...
    query = """SELECT CAST(PNYCKL_DATUM_FOM AS VARCHAR(MAX)) AS PNYCKL_DATUM_FOM,
...
CAST(PNYCKL_TEXT AS VARCHAR(MAX)) AS PNYCKL_TEXT FROM utdata.utdata295.EK_DATUM_OBJ_PNYCKL"""
