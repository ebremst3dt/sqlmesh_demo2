...
@model(
    columns={'YKAT_DATUM_FOM': 'varchar(max)',
 'YKAT_DATUM_TOM': 'varchar(max)',
 'YKAT_GILTIG_FOM': 'varchar(max)',
...
def execute(
    ...
    **kwargs: t.Any,
    ...
    query = """SELECT CAST(YKAT_DATUM_FOM AS VARCHAR(MAX)) AS YKAT_DATUM_FOM,
...
CAST(YKAT_TEXT AS VARCHAR(MAX)) AS YKAT_TEXT FROM utdata.utdata295.EK_DATUM_OBJ_YKAT"""
