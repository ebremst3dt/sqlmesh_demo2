...
@model(
    columns={'ABONNEMANGSID': 'varchar(max)',
 'ANM': 'varchar(max)',
...
def execute(
    ...
    **kwargs: t.Any,
    ...
    query = """SELECT CAST(ABONNEMANGSID AS VARCHAR(MAX)) AS ABONNEMANGSID,
...
CAST(ZVFREFERENS AS VARCHAR(MAX)) AS ZVFREFERENS FROM utdata.utdata295.RK_FAKTA_KUNDBOKDET_FAKT"""
