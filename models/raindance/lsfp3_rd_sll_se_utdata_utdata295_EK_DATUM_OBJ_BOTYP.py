...
def execute(
    ...
    **kwargs: t.Any,
    ...
    query = """SELECT CAST(BOTYP_DATUM_FOM AS VARCHAR(MAX)) AS BOTYP_DATUM_FOM,
...
CAST(BOTYP_TEXT AS VARCHAR(MAX)) AS BOTYP_TEXT FROM utdata.utdata295.EK_DATUM_OBJ_BOTYP"""
