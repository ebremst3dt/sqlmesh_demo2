...
def execute(
    ...
    **kwargs: t.Any,
    ...
    query = """SELECT CAST(BOANTP_DATUM_FOM AS VARCHAR(MAX)) AS BOANTP_DATUM_FOM,
...
CAST(BOANTP_TEXT AS VARCHAR(MAX)) AS BOANTP_TEXT FROM utdata.utdata295.EK_DATUM_OBJ_BOANTP"""
