...
def execute(
    ...
    **kwargs: t.Any,
    ...
    query = """SELECT CAST(DEFANL_DATUM_FOM AS VARCHAR(MAX)) AS DEFANL_DATUM_FOM,
CAST(DEFANL_DATUM_TOM AS VARCHAR(MAX)) AS DEFANL_DATUM_TOM,
...
CAST(DEFANL_TEXT AS VARCHAR(MAX)) AS DEFANL_TEXT FROM utdata.utdata295.EK_DATUM_OBJ_DEFANL"""
