...
@model(
    columns={'PROC_DATUM_FOM': 'varchar(max)',
 'PROC_DATUM_TOM': 'varchar(max)',
 'PROC_GILTIG_FOM': 'varchar(max)',
...
def execute(
    ...
    **kwargs: t.Any,
    ...
    query = """SELECT CAST(PROC_DATUM_FOM AS VARCHAR(MAX)) AS PROC_DATUM_FOM,
...
CAST(PROC_TEXT AS VARCHAR(MAX)) AS PROC_TEXT FROM utdata.utdata295.EK_DATUM_OBJ_PROC"""
