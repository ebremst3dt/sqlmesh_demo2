...
@model(
 ...
 'KUNDID': 'varchar(max)',
 'KUNDID2': 'varchar(max)',
 'KUNDID_ID_TEXT': 'varchar(max)',
 'KUNDID_TEXT': 'varchar(max)',
 'KUND_EREF': 'varchar(max)',
 'KUND_TAB_AVTTYP': 'varchar(max)',
 'KUND_TAB_BEHÄND': 'varchar(max)',
 'KUND_TAB_BETP': 'varchar(max)',
 'KUND_TAB_BETV': 'varchar(max)',
 'KUND_TAB_CMALL': 'varchar(max)',
 'KUND_TAB_EFAKT': 'varchar(max)',
 'KUND_TAB_MOMS': 'varchar(max)',
 'KUND_TAB_MOTP': 'varchar(max)',
 'KUND_TAB_RDEB': 'varchar(max)',
 'KUND_TAB_RESENH': 'varchar(max)',
 'KUND_TAB_SPRÅK': 'varchar(max)',
 'KUND_VREF': 'varchar(max)',
 'LAND': 'varchar(max)',
 'MOMSREG': 'varchar(max)',
...
CAST(TELNR AS VARCHAR(MAX)) AS TELNR FROM utdata.utdata295.RK_DIM_KUND"""
