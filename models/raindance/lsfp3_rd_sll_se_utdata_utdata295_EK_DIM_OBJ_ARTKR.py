...
def execute(
    ...
    **kwargs: t.Any,
    ...
    query = """SELECT CAST(ARTKR_GILTIG_FOM AS VARCHAR(MAX)) AS ARTKR_GILTIG_FOM,
...
CAST(ARTKR_TEXT AS VARCHAR(MAX)) AS ARTKR_TEXT FROM utdata.utdata295.EK_DIM_OBJ_ARTKR"""
