...
@model(
    columns={'URS_GILTIG_FOM': 'varchar(max)',
...
def execute(
    ...
    **kwargs: t.Any,
    ...
    query = """SELECT CAST(URS_GILTIG_FOM AS VARCHAR(MAX)) AS URS_GILTIG_FOM,
...
CAST(URS_TEXT AS VARCHAR(MAX)) AS URS_TEXT FROM utdata.utdata295.EK_DIM_OBJ_URS"""
