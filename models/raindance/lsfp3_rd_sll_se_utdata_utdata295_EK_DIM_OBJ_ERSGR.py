...
def execute(
    ...
    **kwargs: t.Any,
    ...
    query = """SELECT CAST(ERSGR_GILTIG_FOM AS VARCHAR(MAX)) AS ERSGR_GILTIG_FOM,
...
CAST(ERSGR_TEXT AS VARCHAR(MAX)) AS ERSGR_TEXT FROM utdata.utdata295.EK_DIM_OBJ_ERSGR"""
