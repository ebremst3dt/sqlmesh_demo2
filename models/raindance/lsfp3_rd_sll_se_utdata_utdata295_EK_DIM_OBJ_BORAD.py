...
def execute(
    ...
    **kwargs: t.Any,
    ...
    query = """SELECT CAST(BORAD_GILTIG_FOM AS VARCHAR(MAX)) AS BORAD_GILTIG_FOM,
...
CAST(BORAD_TEXT AS VARCHAR(MAX)) AS BORAD_TEXT FROM utdata.utdata295.EK_DIM_OBJ_BORAD"""
