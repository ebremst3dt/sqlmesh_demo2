...
@model(
    columns={'ADR1': 'varchar(max)',
 'ADR2': 'varchar(max)',
 'ATTRIBUTE_ACTORID': 'varchar(max)',
 'ATTRIBUTE_EAN': 'varchar(max)',
 'BANKADR': 'varchar(max)',
 'BANKKONTO': 'varchar(max)',
 'BANKLAND': 'varchar(max)',
 'BANKNAMN': 'varchar(max)',
 'BANKORT': 'varchar(max)',
 'BBAN': 'varchar(max)',
 'BETALVAG': 'varchar(max)',
 'BETSPARR': 'varchar(max)',
 'BGNR': 'varchar(max)',
 'BIC': 'varchar(max)',
 'DUMMY1': 'varchar(max)',
 'ELEKTRONISK_KOMMUNIKATION': 'varchar(max)',
 'ENGANG': 'varchar(max)',
 'FACBG': 'varchar(max)',
 'FACNAMN': 'varchar(max)',
 'FACPG': 'varchar(max)',
 ...
 'GRUPP': 'varchar(max)',
 'IBAN': 'varchar(max)',
 'KREDITLIMIT': 'varchar(max)',
 'LAND': 'varchar(max)',
 'LEVID': 'varchar(max)',
 'LEVID2': 'varchar(max)',
 'LEVID_ID_TEXT': 'varchar(max)',
 'LEVID_TEXT': 'varchar(max)',
 'LEV_EREF': 'varchar(max)',
 'LEV_TAB_BETV': 'varchar(max)',
 'LEV_TAB_BEVAK': 'varchar(max)',
 'LEV_TAB_CMALL': 'varchar(max)',
 'LEV_TAB_FÖRK': 'varchar(max)',
 'LEV_TAB_MOMS': 'varchar(max)',
 'LEV_TAB_MOTP': 'varchar(max)',
 'LEV_TAB_REF': 'varchar(max)',
 'LEV_TAB_RESENH': 'varchar(max)',
 'LEV_TAB_RESK': 'varchar(max)',
 'LEV_TAB_SCADAT': 'varchar(max)',
 'LEV_TAB_SCANNR': 'varchar(max)',
 'LEV_TAB_UBF': 'varchar(max)',
 'LEV_TAB_UBK': 'varchar(max)',
 'LEV_TAB_VALUTA': 'varchar(max)',
 'LEV_VREF': 'varchar(max)',
 'MOMSREG': 'varchar(max)',
 'MSG_DESADV_FORMAT': 'varchar(max)',
 'MSG_DESADV_PA': 'varchar(max)',
 'MSG_DESADV_TRANSPORT': 'varchar(max)',
 'MSG_DESADV_VAG': 'varchar(max)',
 'MSG_EXTORD_FORMAT': 'varchar(max)',
 'MSG_EXTORD_PA': 'varchar(max)',
 'MSG_EXTORD_TRANSPORT': 'varchar(max)',
 'MSG_EXTORD_VAG': 'varchar(max)',
 'MSG_INVOIC_FORMAT': 'varchar(max)',
 'MSG_INVOIC_PA': 'varchar(max)',
 'MSG_INVOIC_TRANSPORT': 'varchar(max)',
 'MSG_INVOIC_VAG': 'varchar(max)',
 'MSG_MSCONS_FORMAT': 'varchar(max)',
 'MSG_MSCONS_PA': 'varchar(max)',
 'MSG_MSCONS_TRANSPORT': 'varchar(max)',
 'MSG_MSCONS_VAG': 'varchar(max)',
 'MSG_ORDERS_FORMAT': 'varchar(max)',
 'MSG_ORDERS_PA': 'varchar(max)',
 'MSG_ORDERS_TRANSPORT': 'varchar(max)',
 'MSG_ORDERS_VAG': 'varchar(max)',
 'MSG_ORDRSP_FORMAT': 'varchar(max)',
 'MSG_ORDRSP_PA': 'varchar(max)',
 'MSG_ORDRSP_TRANSPORT': 'varchar(max)',
 'MSG_ORDRSP_VAG': 'varchar(max)',
 'MSG_PRICAT_FORMAT': 'varchar(max)',
 'MSG_PRICAT_PA': 'varchar(max)',
 'MSG_PRICAT_TRANSPORT': 'varchar(max)',
 'MSG_PRICAT_VAG': 'varchar(max)',
 'MSG_SHOPCART_FORMAT': 'varchar(max)',
 'MSG_SHOPCART_PA': 'varchar(max)',
 'MSG_SHOPCART_TRANSPORT': 'varchar(max)',
 'MSG_SHOPCART_VAG': 'varchar(max)',
 'NAMN2': 'varchar(max)',
 'NATCLEARKOD': 'varchar(max)',
 'OMSATTNING': 'varchar(max)',
 'OMSATTNINGSAR': 'varchar(max)',
 'OMSATTNING_FG': 'varchar(max)',
 'ORGNR': 'varchar(max)',
 'ORT': 'varchar(max)',
 'PASSIV': 'varchar(max)',
 'PGNR': 'varchar(max)',
...
def execute(
    ...
    **kwargs: t.Any,
    ...
    query = """SELECT CAST(ADR1 AS VARCHAR(MAX)) AS ADR1,
...
CAST(TERMIN AS VARCHAR(MAX)) AS TERMIN FROM utdata.utdata295.RK_DIM_LEV"""
