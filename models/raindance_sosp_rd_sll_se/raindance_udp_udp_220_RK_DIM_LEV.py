...
def execute(
    ...
    **kwargs: t.Any,
	...
	SELECT * FROM (SELECT 
		...
		CAST(LEV_TAB_BMOMS AS VARCHAR(MAX)) AS lev_tab_bmoms,
		...
		CAST(LEV_TAB_RKST AS VARCHAR(MAX)) AS lev_tab_rkst,
