...
@model(
    columns={'_data_modified_utc': 'date', '_metadata_modified_utc': 'datetime2', '_source': 'varchar(max)', 'GRUPP_GILTIG_FOM': 'varchar(max)', 'GRUPP_GILTIG_TOM': 'varchar(max)', 'GRUPP_ID': 'varchar(max)', 'GRUPP_ID_TEXT': 'varchar(max)', 'GRUPP_PASSIV': 'varchar(max)', 'GRUPP_TEXT': 'varchar(max)'},
    kind=dict(
