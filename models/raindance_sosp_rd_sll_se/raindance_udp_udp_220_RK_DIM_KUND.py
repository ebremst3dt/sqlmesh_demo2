...
def execute(
    ...
    **kwargs: t.Any,
	...
	SELECT * FROM (SELECT 
		...
		CAST(KUND_TAB_REF AS VARCHAR(MAX)) AS kund_tab_ref,
		...
		CAST(KUND_TAB_VT AS VARCHAR(MAX)) AS kund_tab_vt,
