...
@model(
    columns={'_data_modified_utc': 'date', '_metadata_modified_utc': 'datetime2', '_source': 'varchar(max)', 'TDAG_GILTIG_FOM': 'varchar(max)', 'TDAG_GILTIG_TOM': 'varchar(max)', 'TDAG_ID': 'varchar(max)', 'TDAG_ID_TEXT': 'varchar(max)', 'TDAG_PASSIV': 'varchar(max)', 'TDAG_TEXT': 'varchar(max)'},
    kind=dict(
