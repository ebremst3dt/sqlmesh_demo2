...
@model(
    columns={'_data_modified_utc': 'date', '_metadata_modified_utc': 'datetime2', '_source': 'varchar(max)', 'PTYP_GILTIG_FOM': 'varchar(max)', 'PTYP_GILTIG_TOM': 'varchar(max)', 'PTYP_ID': 'varchar(max)', 'PTYP_ID_TEXT': 'varchar(max)', 'PTYP_PASSIV': 'varchar(max)', 'PTYP_TEXT': 'varchar(max)'},
    kind=dict(
