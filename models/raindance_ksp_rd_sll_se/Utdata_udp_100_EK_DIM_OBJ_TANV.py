...
@model(
    columns={'_data_modified_utc': 'date', '_metadata_modified_utc': 'datetime2', '_source': 'varchar(max)', 'TANV_GILTIG_FOM': 'varchar(max)', 'TANV_GILTIG_TOM': 'varchar(max)', 'TANV_ID': 'varchar(max)', 'TANV_ID_TEXT': 'varchar(max)', 'TANV_PASSIV': 'varchar(max)', 'TANV_TEXT': 'varchar(max)'},
    kind=dict(
