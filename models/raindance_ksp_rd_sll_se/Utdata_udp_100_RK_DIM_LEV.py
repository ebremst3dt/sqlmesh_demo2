...
def execute(
    ...
    **kwargs: t.Any,
	...
	SELECT * FROM (SELECT 
		...
		CAST(LEV_TAB_A#P AS VARCHAR(MAX)) AS LEV_TAB_A#P,
		...
		CAST(LEV_TAB_DIV AS VARCHAR(MAX)) AS LEV_TAB_DIV,
		CAST(LEV_TAB_EXPORT AS VARCHAR(MAX)) AS LEV_TAB_EXPORT,
		CAST(LEV_TAB_HANDL AS VARCHAR(MAX)) AS LEV_TAB_HANDL,
		CAST(LEV_TAB_KLIN AS VARCHAR(MAX)) AS LEV_TAB_KLIN,
		...
		CAST(LEV_TAB_SNI AS VARCHAR(MAX)) AS LEV_TAB_SNI,
		CAST(LEV_TAB_UBF AS VARCHAR(MAX)) AS LEV_TAB_UBF,
		CAST(LEV_TAB_UBK AS VARCHAR(MAX)) AS LEV_TAB_UBK,
		CAST(LEV_TAB_VALR AS VARCHAR(MAX)) AS LEV_TAB_VALR,
		CAST(LEV_TAB_VARUKD AS VARCHAR(MAX)) AS LEV_TAB_VARUKD,
