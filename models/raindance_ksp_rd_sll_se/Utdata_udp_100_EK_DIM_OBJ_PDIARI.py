...
@model(
    columns={'_data_modified_utc': 'date', '_metadata_modified_utc': 'datetime2', '_source': 'varchar(max)', 'PDIARI_GILTIG_FOM': 'varchar(max)', 'PDIARI_GILTIG_TOM': 'varchar(max)', 'PDIARI_ID': 'varchar(max)', 'PDIARI_ID_TEXT': 'varchar(max)', 'PDIARI_PASSIV': 'varchar(max)', 'PDIARI_TEXT': 'varchar(max)'},
    kind=dict(
