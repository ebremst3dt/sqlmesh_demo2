...
@model(
    ...
    start=start,
    cron="@daily",
    post_statements=["CREATE INDEX IF NOT EXISTS sllclockdb01_dc_sll_se_rainbow_md_rainbow_whs_data_modified_utc ON clockwork_sllclockdb01_dc_sll_se.rainbow_md_rainbow_whs (_data_modified_utc)"]
)
