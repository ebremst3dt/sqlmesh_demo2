...
@model(
    columns={'_data_modified_utc': 'date', '_metadata_modified_utc': 'datetime2', '_source_catalog': 'varchar(max)', 'actcod': 'varchar(max)', 'actdat': 'varchar(max)', 'acttim': 'varchar(max)', 'actusr': 'varchar(max)', 'addcst': 'varchar(max)', 'addmrk': 'varchar(max)', 'addsal': 'varchar(max)', 'agncod': 'varchar(max)', 'aodmid': 'varchar(max)', 'cbchld': 'varchar(max)', 'cdcusn': 'varchar(max)', 'cddlvo': 'varchar(max)', 'chgdat': 'varchar(max)', 'chgusr': 'varchar(max)', 'chncod': 'varchar(max)', 'cnvexc': 'varchar(max)', 'compny': 'varchar(max)', 'copsor': 'varchar(max)', 'covval': 'varchar(max)', 'credat': 'varchar(max)', 'creusr': 'varchar(max)', 'csccod': 'varchar(max)', 'cstval': 'varchar(max)', 'ctrhnd': 'varchar(max)', 'curcod': 'varchar(max)', 'curtyp': 'varchar(max)', 'dathld': 'varchar(max)', 'ddldat': 'varchar(max)', 'defprc': 'varchar(max)', 'disprc': 'varchar(max)', 'disval': 'varchar(max)', 'dlachg': 'varchar(max)', 'dlvdat': 'varchar(max)', 'dptcod': 'varchar(max)', 'dspcod': 'varchar(max)', 'dspdat': 'varchar(max)', 'dspnam': 'varchar(max)', 'dsptyp': 'varchar(max)', 'edists': 'varchar(max)', 'ettcod': 'varchar(max)', 'euscod': 'varchar(max)', 'eusnam': 'varchar(max)', 'excdat': 'varchar(max)', 'excrat': 'varchar(max)', 'expdat': 'varchar(max)', 'extord': 'varchar(max)', 'faxdat': 'varchar(max)', 'faxsts': 'varchar(max)', 'fixdsc': 'varchar(max)', 'frtcod': 'varchar(max)', 'fwacod': 'varchar(max)', 'fwdcod': 'varchar(max)', 'gencod': 'varchar(max)', 'grsam2': 'varchar(max)', 'grsvdm': 'varchar(max)', 'grswgk': 'varchar(max)', 'gvrcod': 'varchar(max)', 'hldmin': 'varchar(max)', 'incmrp': 'varchar(max)', 'invfee': 'varchar(max)', 'ipdnum': 'varchar(max)', 'llccod': 'varchar(max)', 'lngcod': 'varchar(max)', 'lsdldt': 'varchar(max)', 'lststs': 'varchar(max)', 'manddn': 'varchar(max)', 'manddt': 'varchar(max)', 'manddv': 'varchar(max)', 'manfrt': 'varchar(max)', 'markup': 'varchar(max)', 'mstfot': 'varchar(max)', 'mstfrt': 'varchar(max)', 'mstpyp': 'varchar(max)', 'msttra': 'varchar(max)', 'ndldat': 'varchar(max)', 'netam2': 'varchar(max)', 'netvdm': 'varchar(max)', 'netwgk': 'varchar(max)', 'ntfdat': 'varchar(max)', 'ntfown': 'varchar(max)', 'ntftim': 'varchar(max)', 'numchg': 'varchar(max)', 'onhold': 'varchar(max)', 'ordcnf': 'varchar(max)', 'ordval': 'varchar(max)', 'otscod': 'varchar(max)', 'otsgrp': 'varchar(max)', 'ourctc': 'varchar(max)', 'ourref': 'varchar(max)', 'owncod': 'varchar(max)', 'ownctc': 'varchar(max)', 'owndat': 'varchar(max)', 'ownref': 'varchar(max)', 'ownrf2': 'varchar(max)', 'owntyp': 'varchar(max)', 'paycod': 'varchar(max)', 'paynam': 'varchar(max)', 'paytyp': 'varchar(max)', 'pctcod': 'varchar(max)', 'prbblt': 'varchar(max)', 'pricod': 'varchar(max)', 'prjcod': 'varchar(max)', 'prjprc': 'varchar(max)', 'prttxd': 'varchar(max)', 'prttxf': 'varchar(max)', 'prttxg': 'varchar(max)', 'prttxh': 'varchar(max)', 'rcvdat': 'varchar(max)', 'rcvfrm': 'varchar(max)', 'rcvnam': 'varchar(max)', 'rcvunt': 'varchar(max)', 'regdat': 'varchar(max)', 'rutcod': 'varchar(max)', 'sapcod': 'varchar(max)', 'sbccod': 'varchar(max)', 'scccod': 'varchar(max)', 'sdxcod': 'varchar(max)', 'sifcod': 'varchar(max)', 'sixcod': 'varchar(max)', 'snginv': 'varchar(max)', 'sngtrs': 'varchar(max)', 'soahnd': 'varchar(max)', 'sornum': 'varchar(max)', 'splcod': 'varchar(max)', 'sysddn': 'varchar(max)', 'sysddt': 'varchar(max)', 'sysddv': 'varchar(max)', 'tdlcod': 'varchar(max)', 'tdlown': 'varchar(max)', 'tpycod': 'varchar(max)', 'tpyown': 'varchar(max)', 'trfhst': 'varchar(max)', 'trfsta': 'varchar(max)', 'trssts': 'varchar(max)', 'txtdlv': 'varchar(max)', 'txtfot': 'varchar(max)', 'txtgen': 'varchar(max)', 'txthed': 'varchar(max)', 'txtinv': 'varchar(max)', 'usemai': 'varchar(max)', 'useref': 'varchar(max)', 'usrhld': 'varchar(max)', 'vatcod': 'varchar(max)', 'vatuse': 'varchar(max)', 'wtrcod': 'varchar(max)', 'wtrown': 'varchar(max)', 'xtccod': 'varchar(max)'},
    kind=dict(
        name=ModelKindName.INCREMENTAL_BY_UNIQUE_KEY,
        batch_size=30,
        unique_key=['compny', 'sornum']
    ),
    start=start,
    cron="0 2 * * *",
    post_statements=["CREATE INDEX IF NOT EXISTS sllclockdb01_dc_sll_se_rainbow_slso_rainbow_soh_data_modified_utc ON clockwork_sllclockdb01_dc_sll_se.rainbow_slso_rainbow_soh (_data_modified_utc)"]
)
