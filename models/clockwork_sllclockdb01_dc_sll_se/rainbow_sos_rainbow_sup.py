...
@model(
    columns={'_data_modified_utc': 'date', '_metadata_modified_utc': 'datetime2', '_source_catalog': 'varchar(max)', 'abcexd': 'varchar(max)', 'abcexu': 'varchar(max)', 'abcfvd': 'varchar(max)', 'abcfvu': 'varchar(max)', 'abcpvd': 'varchar(max)', 'abcpvu': 'varchar(max)', 'abcsld': 'varchar(max)', 'abcslu': 'varchar(max)', 'acmcod': 'varchar(max)', 'adrctr': 'varchar(max)', 'agncod': 'varchar(max)', 'agporp': 'varchar(max)', 'appcls': 'varchar(max)', 'appfda': 'varchar(max)', 'appuda': 'varchar(max)', 'asupnm': 'varchar(max)', 'auorrq': 'varchar(max)', 'bankac': 'varchar(max)', 'barcod': 'varchar(max)', 'bnsccm': 'varchar(max)', 'cabcex': 'varchar(max)', 'cabcfv': 'varchar(max)', 'cabcpv': 'varchar(max)', 'cabcsl': 'varchar(max)', 'ccdlvs': 'varchar(max)', 'chgdat': 'varchar(max)', 'chgusr': 'varchar(max)', 'chncod': 'varchar(max)', 'chnfrm': 'varchar(max)', 'chnunt': 'varchar(max)', 'clicod': 'varchar(max)', 'cnfpfc': 'varchar(max)', 'cnsrr2': 'varchar(max)', 'cnssep': 'varchar(max)', 'cntcod': 'varchar(max)', 'compny': 'varchar(max)', 'crbcod': 'varchar(max)', 'crbplm': 'varchar(max)', 'credat': 'varchar(max)', 'creusr': 'varchar(max)', 'csldld': 'varchar(max)', 'csldlu': 'varchar(max)', 'csldlv': 'varchar(max)', 'csvclq': 'varchar(max)', 'csvlqd': 'varchar(max)', 'csvlqu': 'varchar(max)', 'ctcprs': 'varchar(max)', 'ctrdis': 'varchar(max)', 'ctrpri': 'varchar(max)', 'curcod': 'varchar(max)', 'curtyp': 'varchar(max)', 'dcscod': 'varchar(max)', 'defprc': 'varchar(max)', 'dicing': 'varchar(max)', 'dladr1': 'varchar(max)', 'dladr2': 'varchar(max)', 'dladr3': 'varchar(max)', 'dladr4': 'varchar(max)', 'dlgcod': 'varchar(max)', 'dlgown': 'varchar(max)', 'dlvstp': 'varchar(max)', 'dstcod': 'varchar(max)', 'ecland': 'varchar(max)', 'ecregn': 'varchar(max)', 'enblda': 'varchar(max)', 'enblva': 'varchar(max)', 'entfrm': 'varchar(max)', 'envcls': 'varchar(max)', 'envfda': 'varchar(max)', 'envuda': 'varchar(max)', 'extcod': 'varchar(max)', 'extprf': 'varchar(max)', 'exwldt': 'varchar(max)', 'faxswt': 'varchar(max)', 'fcoddl': 'varchar(max)', 'fixdsc': 'varchar(max)', 'fwacod': 'varchar(max)', 'fwdcod': 'varchar(max)', 'genpfc': 'varchar(max)', 'gentxt': 'varchar(max)', 'hidsrc': 'varchar(max)', 'hndldt': 'varchar(max)', 'ibancd': 'varchar(max)', 'intext': 'varchar(max)', 'invapr': 'varchar(max)', 'invfrq': 'varchar(max)', 'lintyp': 'varchar(max)', 'lngcod': 'varchar(max)', 'maadr1': 'varchar(max)', 'maadr2': 'varchar(max)', 'maadr3': 'varchar(max)', 'maadr4': 'varchar(max)', 'markup': 'varchar(max)', 'mstbbs': 'varchar(max)', 'mstmrk': 'varchar(max)', 'mstupe': 'varchar(max)', 'ntffco': 'varchar(max)', 'ntfown': 'varchar(max)', 'ourcod': 'varchar(max)', 'owncod': 'varchar(max)', 'owntyp': 'varchar(max)', 'pabcex': 'varchar(max)', 'pabcfv': 'varchar(max)', 'pabcpv': 'varchar(max)', 'pabcsl': 'varchar(max)', 'pdpcod': 'varchar(max)', 'phnext': 'varchar(max)', 'phnfwd': 'varchar(max)', 'phnprc': 'varchar(max)', 'phnsvc': 'varchar(max)', 'phnswt': 'varchar(max)', 'phnwhs': 'varchar(max)', 'postac': 'varchar(max)', 'prccod': 'varchar(max)', 'prfcod': 'varchar(max)', 'pricod': 'varchar(max)', 'psvcld': 'varchar(max)', 'psvclq': 'varchar(max)', 'ptdlvm': 'varchar(max)', 'regcod': 'varchar(max)', 'regnum': 'varchar(max)', 'sbiacp': 'varchar(max)', 'sbihrz': 'varchar(max)', 'sbiuse': 'varchar(max)', 'sctcod': 'varchar(max)', 'sdxcod': 'varchar(max)', 'sgrcod': 'varchar(max)', 'sifcod': 'varchar(max)', 'sixcod': 'varchar(max)', 'splcod': 'varchar(max)', 'splord': 'varchar(max)', 'srtnam': 'varchar(max)', 'srtnum': 'varchar(max)', 'stdldt': 'varchar(max)', 'stycod': 'varchar(max)', 'supact': 'varchar(max)', 'supcod': 'varchar(max)', 'suplcy': 'varchar(max)', 'supnam': 'varchar(max)', 'swiftc': 'varchar(max)', 'tlxswt': 'varchar(max)', 'tpycod': 'varchar(max)', 'tpyown': 'varchar(max)', 'updeco': 'varchar(max)', 'vatcod': 'varchar(max)', 'vatnum': 'varchar(max)', 'viadr1': 'varchar(max)', 'viadr2': 'varchar(max)', 'viadr3': 'varchar(max)', 'viadr4': 'varchar(max)', 'whscod': 'varchar(max)', 'xtccod': 'varchar(max)'},
    kind=dict(
        name=ModelKindName.INCREMENTAL_BY_UNIQUE_KEY,
        batch_size=30,
        unique_key=['compny', 'supcod']
    ),
    start=start,
    cron="0 2 * * *",
    post_statements=["CREATE INDEX IF NOT EXISTS sllclockdb01_dc_sll_se_rainbow_sos_rainbow_sup_data_modified_utc ON clockwork_sllclockdb01_dc_sll_se.rainbow_sos_rainbow_sup (_data_modified_utc)"]
)
