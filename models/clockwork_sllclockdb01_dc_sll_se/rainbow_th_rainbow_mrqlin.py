...
@model(
    ...
    cron="@daily",
    post_statements=["CREATE INDEX IF NOT EXISTS sllclockdb01_dc_sll_se_rainbow_th_rainbow_mrqlin_data_modified_utc ON clockwork_sllclockdb01_dc_sll_se.rainbow_th_rainbow_mrqlin (_data_modified_utc)"]
)
...
def execute(
    ...
    **kwargs: t.Any,
	...
	FROM Rainbow_TH.rainbow.mrqlin
     )y
