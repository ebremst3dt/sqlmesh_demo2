...
@model(
    ...
    start=start,
    cron="0 2 * * *",
    post_statements=["CREATE INDEX IF NOT EXISTS sllclockdb01_dc_sll_se_rainbow_th_rainbow_itm_data_modified_utc ON clockwork_sllclockdb01_dc_sll_se.rainbow_th_rainbow_itm (_data_modified_utc)"]
)
