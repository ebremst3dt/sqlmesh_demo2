...
@model(
    columns={'_data_modified_utc': 'date', '_metadata_modified_utc': 'datetime2', '_source_catalog': 'varchar(max)', 'actcod': 'varchar(max)', 'adrctr': 'varchar(max)', 'aphdlc': 'varchar(max)', 'appcls': 'varchar(max)', 'appfda': 'varchar(max)', 'appuda': 'varchar(max)', 'apwhsc': 'varchar(max)', 'auidar': 'varchar(max)', 'autalc': 'varchar(max)', 'autpck': 'varchar(max)', 'awhsnm': 'varchar(max)', 'bankac': 'varchar(max)', 'blltyp': 'varchar(max)', 'ccdlvs': 'varchar(max)', 'cdcval': 'varchar(max)', 'chgdat': 'varchar(max)', 'chgusr': 'varchar(max)', 'clicod': 'varchar(max)', 'cnsreg': 'varchar(max)', 'cntcod': 'varchar(max)', 'compny': 'varchar(max)', 'cpccby': 'varchar(max)', 'crbcod': 'varchar(max)', 'crbplm': 'varchar(max)', 'credat': 'varchar(max)', 'creusr': 'varchar(max)', 'crpwhs': 'varchar(max)', 'csccod': 'varchar(max)', 'csldlu': 'varchar(max)', 'csldlv': 'varchar(max)', 'csttou': 'varchar(max)', 'csttov': 'varchar(max)', 'ctcprs': 'varchar(max)', 'curcod': 'varchar(max)', 'curtyp': 'varchar(max)', 'dbdpdc': 'varchar(max)', 'dbdprc': 'varchar(max)', 'dcscod': 'varchar(max)', 'defacs': 'varchar(max)', 'defprc': 'varchar(max)', 'dladr1': 'varchar(max)', 'dladr2': 'varchar(max)', 'dladr3': 'varchar(max)', 'dladr4': 'varchar(max)', 'dlgcod': 'varchar(max)', 'dmdwhs': 'varchar(max)', 'dptcod': 'varchar(max)', 'dstcod': 'varchar(max)', 'ecland': 'varchar(max)', 'eclins': 'varchar(max)', 'ecregn': 'varchar(max)', 'enblma': 'varchar(max)', 'enblva': 'varchar(max)', 'ettcod': 'varchar(max)', 'exwldt': 'varchar(max)', 'faxswt': 'varchar(max)', 'ficinv': 'varchar(max)', 'fixarr': 'varchar(max)', 'fixcrd': 'varchar(max)', 'fixdsc': 'varchar(max)', 'fixdsm': 'varchar(max)', 'fixdsp': 'varchar(max)', 'fixeoo': 'varchar(max)', 'fixeor': 'varchar(max)', 'fixiin': 'varchar(max)', 'fixior': 'varchar(max)', 'fixotv': 'varchar(max)', 'fixpal': 'varchar(max)', 'fixpil': 'varchar(max)', 'fixpll': 'varchar(max)', 'fixprc': 'varchar(max)', 'fixprq': 'varchar(max)', 'fixrcp': 'varchar(max)', 'fixreq': 'varchar(max)', 'fixrpl': 'varchar(max)', 'fixsor': 'varchar(max)', 'fixstt': 'varchar(max)', 'fwacod': 'varchar(max)', 'fwdcod': 'varchar(max)', 'fwstop': 'varchar(max)', 'gtwcod': 'varchar(max)', 'gwlcod': 'varchar(max)', 'gwltyp': 'varchar(max)', 'hidsrc': 'varchar(max)', 'hndcst': 'varchar(max)', 'hndldt': 'varchar(max)', 'hndtim': 'varchar(max)', 'hsthrz': 'varchar(max)', 'inscby': 'varchar(max)', 'inssts': 'varchar(max)', 'intext': 'varchar(max)', 'intloc': 'varchar(max)', 'invfrq': 'varchar(max)', 'irtcod': 'varchar(max)', 'isacby': 'varchar(max)', 'isactr': 'varchar(max)', 'isamsg': 'varchar(max)', 'isazch': 'varchar(max)', 'isssc1': 'varchar(max)', 'jobque': 'varchar(max)', 'lczlbl': 'varchar(max)', 'lczpcf': 'varchar(max)', 'linstp': 'varchar(max)', 'lintyp': 'varchar(max)', 'llccod': 'varchar(max)', 'lngcod': 'varchar(max)', 'locism': 'varchar(max)', 'maadr1': 'varchar(max)', 'maadr2': 'varchar(max)', 'maadr3': 'varchar(max)', 'maadr4': 'varchar(max)', 'manreq': 'varchar(max)', 'markup': 'varchar(max)', 'mrappw': 'varchar(max)', 'mrapus': 'varchar(max)', 'mrenit': 'varchar(max)', 'mrensu': 'varchar(max)', 'mstbbs': 'varchar(max)', 'mstlcm': 'varchar(max)', 'mstmrk': 'varchar(max)', 'ortcod': 'varchar(max)', 'otccod': 'varchar(max)', 'otrcdb': 'varchar(max)', 'otrcod': 'varchar(max)', 'otrcrt': 'varchar(max)', 'otropn': 'varchar(max)', 'otrrtn': 'varchar(max)', 'otsstt': 'varchar(max)', 'otvcod': 'varchar(max)', 'owncod': 'varchar(max)', 'owntyp': 'varchar(max)', 'pckalc': 'varchar(max)', 'pckhrz': 'varchar(max)', 'pcksor': 'varchar(max)', 'pckwor': 'varchar(max)', 'phnext': 'varchar(max)', 'phnswt': 'varchar(max)', 'picfil': 'varchar(max)', 'postac': 'varchar(max)', 'prccod': 'varchar(max)', 'prczon': 'varchar(max)', 'prdstc': 'varchar(max)', 'prfcod': 'varchar(max)', 'pricod': 'varchar(max)', 'prpfwa': 'varchar(max)', 'prprcv': 'varchar(max)', 'prprel': 'varchar(max)', 'prpses': 'varchar(max)', 'prtisa': 'varchar(max)', 'prtism': 'varchar(max)', 'prtist': 'varchar(max)', 'prtisx': 'varchar(max)', 'pstcod': 'varchar(max)', 'psttov': 'varchar(max)', 'psvcld': 'varchar(max)', 'ptdlvm': 'varchar(max)', 'qlmcod': 'varchar(max)', 'regcod': 'varchar(max)', 'regnum': 'varchar(max)', 'rspwhs': 'varchar(max)', 'sclins': 'varchar(max)', 'scocod': 'varchar(max)', 'scpwhs': 'varchar(max)', 'sdxcod': 'varchar(max)', 'sifcod': 'varchar(max)', 'sixcod': 'varchar(max)', 'sordas': 'varchar(max)', 'sordcp': 'varchar(max)', 'sorddl': 'varchar(max)', 'sordpk': 'varchar(max)', 'sordpl': 'varchar(max)', 'splcod': 'varchar(max)', 'splpck': 'varchar(max)', 'splpll': 'varchar(max)', 'srtnam': 'varchar(max)', 'srtnum': 'varchar(max)', 'srtpck': 'varchar(max)', 'srtpt1': 'varchar(max)', 'stdldt': 'varchar(max)', 'stltyp': 'varchar(max)', 'svccod': 'varchar(max)', 'tlxswt': 'varchar(max)', 'tpycod': 'varchar(max)', 'tpyown': 'varchar(max)', 'usdmac': 'varchar(max)', 'usecdc': 'varchar(max)', 'usfcst': 'varchar(max)', 'usfifo': 'varchar(max)', 'usmulo': 'varchar(max)', 'uspdst': 'varchar(max)', 'ustrlo': 'varchar(max)', 'valfrm': 'varchar(max)', 'valunt': 'varchar(max)', 'vatcod': 'varchar(max)', 'vatnum': 'varchar(max)', 'vcrgrp': 'varchar(max)', 'viadr1': 'varchar(max)', 'viadr2': 'varchar(max)', 'viadr3': 'varchar(max)', 'viadr4': 'varchar(max)', 'wctcod': 'varchar(max)', 'wgrcod': 'varchar(max)', 'whsact': 'varchar(max)', 'whscod': 'varchar(max)', 'whscst': 'varchar(max)', 'whsfrm': 'varchar(max)', 'whslcy': 'varchar(max)', 'whsnam': 'varchar(max)', 'whstyp': 'varchar(max)', 'wttdma': 'varchar(max)', 'wttdmr': 'varchar(max)', 'wttiss': 'varchar(max)', 'wttmrc': 'varchar(max)', 'wttwdw': 'varchar(max)', 'wtycod': 'varchar(max)', 'xtccod': 'varchar(max)'},
    kind=dict(
        name=ModelKindName.INCREMENTAL_BY_UNIQUE_KEY,
        batch_size=5000,
        unique_key=['compny', 'whscod']
    ),
    start=start,
    cron="@daily",
    post_statements=["CREATE INDEX IF NOT EXISTS sllclockdb01_dc_sll_se_rainbow_slso_rainbow_whs_data_modified_utc ON clockwork_sllclockdb01_dc_sll_se.rainbow_slso_rainbow_whs (_data_modified_utc)"]
)
