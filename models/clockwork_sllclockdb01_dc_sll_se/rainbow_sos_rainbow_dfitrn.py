...
@model(
    ...
    start=start,
    cron="@daily",
    post_statements=["CREATE INDEX IF NOT EXISTS sllclockdb01_dc_sll_se_rainbow_sos_rainbow_dfitrn_data_modified_utc ON clockwork_sllclockdb01_dc_sll_se.rainbow_sos_rainbow_dfitrn (_data_modified_utc)"]
)
...
def execute(
    ...
    **kwargs: t.Any,
	...
	FROM Rainbow_SOS.rainbow.dfitrn
     )y
