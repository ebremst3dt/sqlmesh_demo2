...
@model(
 ...
 'wtrown': 'varchar(max)'},
    ...
    cron="@daily",
    post_statements=["CREATE INDEX IF NOT EXISTS sllclockdb01_dc_sll_se_Rainbow_SLSO_rainbow_poh_data_modified_utc ON clockwork.sllclockdb01_dc_sll_se_Rainbow_SLSO_rainbow_poh (_data_modified_utc)"]
)
