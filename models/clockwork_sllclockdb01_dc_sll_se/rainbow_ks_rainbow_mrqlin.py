...
@model(
    ...
    cron="@daily",
    post_statements=["CREATE INDEX IF NOT EXISTS sllclockdb01_dc_sll_se_Rainbow_KS_rainbow_mrqlin_data_modified_utc ON clockwork_sllclockdb01_dc_sll_se.Rainbow_KS_rainbow_mrqlin (_data_modified_utc)"]
)
