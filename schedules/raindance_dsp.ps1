# Create a trigger that runs daily at 3:00 AM
$trigger = New-JobTrigger -Daily -At "3:00 AM"
$options = New-ScheduledJobOption -RunElevated

Register-ScheduledJob -Name "raindance_dsp_daily" -ScriptBlock {
    # Get current timestamp for file naming
    $job_name = "raindance_dsp_daily"
    ...
    $output = & sqlmesh --paths "C:\Users\GAISYSBH2D\sqlmesh_demo2\" run --select-model "raindance_dsp*" prod 2>&1
