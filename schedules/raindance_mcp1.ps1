...
Register-ScheduledJob -Name "raindance_mcp1_daily" -ScriptBlock {
    # Get current timestamp for file naming
    $job_name = "raindance_mcp1_daily"
    ...
    $output = & sqlmesh --paths "C:\Users\GAISYSBH2D\sqlmesh_demo2\" run --select-model "raindance_mcp1*" prod 2>&1
