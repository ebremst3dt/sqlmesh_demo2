...
Register-ScheduledJob -Name "raindance_nksp_daily" -ScriptBlock {
    # Get current timestamp for file naming
    $job_name = "raindance_nksp_daily"
    ...
    $output = & sqlmesh --paths "C:\Users\GAISYSBH2D\sqlmesh_demo2\" run --select-model "raindance_nksp*" prod 2>&1
