...
Register-ScheduledJob -Name "raindance_sosp_daily" -ScriptBlock {
    # Get current timestamp for file naming
    $job_name = "raindance_sosp_daily"
    ...
    $output = & sqlmesh --paths "C:\Users\GAISYSBH2D\sqlmesh_demo2\" run --select-model "raindance_sosp*" prod 2>&1
