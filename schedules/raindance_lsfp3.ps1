# Create a trigger that runs daily at 2:00 AM
$trigger = New-JobTrigger -Daily -At "5:00 AM"
$options = New-ScheduledJobOption -RunElevated

Register-ScheduledJob -Name "raindance_lsfp3_daily" -ScriptBlock {
    # Get current timestamp for file naming
    $job_name = "raindance_lsfp3_daily"
    ...
    $output = & sqlmesh --paths "C:\Users\GAISYSBH2D\sqlmesh_demo2\" run --select-model "raindance_lsfp3*" prod 2>&1
