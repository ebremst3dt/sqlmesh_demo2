...
Register-ScheduledJob -Name "raindance_ftvddbs08_daily" -ScriptBlock {
    # Get current timestamp for file naming
    $job_name = "raindance_ftvddbs08_daily"
    ...
    $output = & sqlmesh --paths "C:\Users\GAISYSBH2D\sqlmesh_demo2\" run --select-model "raindance_ftvddbs08*" prod 2>&1
