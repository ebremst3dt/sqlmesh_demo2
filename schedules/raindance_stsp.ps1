...
Register-ScheduledJob -Name "raindance_stsp_rd_sll_se_daily" -ScriptBlock {
    # Get current timestamp for file naming
    $job_name = "raindance_stsp_rd_sll_se_daily"
    ...
    $output = & sqlmesh --paths "C:\Users\GAISYSBH2D\sqlmesh_demo2\" run --select-model "raindance_stsp_rd_sll_se*" prod 2>&1
