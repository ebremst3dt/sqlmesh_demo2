...
Register-ScheduledJob -Name "raindance_rnddbp01_daily" -ScriptBlock {
    # Get current timestamp for file naming
    $job_name = "raindance_rnddbp01_daily"
    ...
    $output = & sqlmesh --paths "C:\Users\GAISYSBH2D\sqlmesh_demo2\" run --select-model "raindance_rnddbp01*" prod 2>&1
